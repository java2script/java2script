...
Control getControl (Object handle) {
	...
	*/
	...
	for (int i = 0; i < controlTable.length; i++) {
		if (controlTable[i] != null && handle == controlTable[i].handle) {
...
public Color getSystemColor (int id) {
	...
	*/
	String pixel = "#000000";
	switch (id) {
		case SWT.COLOR_WIDGET_DARK_SHADOW:		pixel = "ThreeDDarkShadow";	break;
		case SWT.COLOR_WIDGET_NORMAL_SHADOW:	pixel = "ThreeDShadow"; 	break;
		case SWT.COLOR_WIDGET_LIGHT_SHADOW: 	pixel = "ThreeDLightShadow";  	break;
		case SWT.COLOR_WIDGET_HIGHLIGHT_SHADOW:	pixel = "ThreeDHighlight";  break;
		case SWT.COLOR_WIDGET_BACKGROUND: 		pixel = "ThreeDFace";  	break;
		case SWT.COLOR_WIDGET_BORDER: 		pixel = "WindowFrame";  break;
		case SWT.COLOR_WIDGET_FOREGROUND:
		case SWT.COLOR_LIST_FOREGROUND: 		pixel = "WindowText";	break;
		case SWT.COLOR_LIST_BACKGROUND: 		pixel = "Window";  	break;
		case SWT.COLOR_LIST_SELECTION: 		pixel = "Highlight";	break;
		case SWT.COLOR_LIST_SELECTION_TEXT: 	pixel = "HighlightText";break;
		case SWT.COLOR_INFO_FOREGROUND:		pixel = "InfoText";	break;
		case SWT.COLOR_INFO_BACKGROUND:		pixel = "InfoBackground";		break;
		case SWT.COLOR_TITLE_FOREGROUND: 		pixel = "CaptionText";	break;
		case SWT.COLOR_TITLE_BACKGROUND:		pixel = "ActiveCaption";		break;
		case SWT.COLOR_TITLE_BACKGROUND_GRADIENT: 
			pixel = "ActiveCaption";
			break;
		case SWT.COLOR_TITLE_INACTIVE_FOREGROUND: 		pixel = "InactiveCaptionText";	break;
		case SWT.COLOR_TITLE_INACTIVE_BACKGROUND:			pixel = "InactiveCaption";		break;
		case SWT.COLOR_TITLE_INACTIVE_BACKGROUND_GRADIENT:	
