...
final public class AU {
  ...
  private static Object newInstanceO(Object array, int n) {
     ...
     * @j2sNative
     * 
     * if (Clazz.newArray && (!array.getClass || !array.getClass().getComponentType))
     * 	 return new Array(n);
     * 
     */
    {
  ...
  public static int[] arrayCopyRangeRevI(int[] array, int i0, int n) {
     ...
     * @j2sNative
     * 
     * if (Clazz.newArry) return Clazz.newArray(-1, array, i0, n).reverse();
     */
    {
    }
  ...
  */
  ...
  public static float[][] newFloat2(int n) {
     ...
     * @j2sNative
     * 
     * if (Clazz.newArray) return Clazz.newArray(n, null);
     * 
     */
    {
    }
  ...
  public static int[][][] newInt3(int nx, int ny) {
     ...
     * @j2sNative
     * 
     * if (Clazz.newArray) return Clazz.newArray(nx, null);
     * 
     */
    {
    }
  ...
  public static int removeMapKeys(Map<String, ?> map, String root) {
	...
	public static boolean isAS(Object x) {
	   ...
	   * 
	   * @j2sNative
	   *  if (Class.newArray) return Clazz.isAS(x);
	   */
	  {
	  }
	...
	public static boolean isASS(Object x) {
	  /**
	   * @j2sNative
	   *  if (Class.newArray) return Clazz.isASS(x);
	   */
	  {
	  }
	  return x instanceof String[][];
	...
	public static boolean isAP(Object x) {
	  /**
	   * @j2sNative
	   *  if (Class.newArray) return Clazz.isAP(x);
	   */
	  {
	  }
	...
	public static boolean isAF(Object x) {
	  /**
	   * @j2sNative
	   *  if (Class.newArray) return Clazz.isAF(x);
	   */
	  {
	  }
	...
	public static boolean isAFloat(Object x) {
	  /**
	   * @j2sNative
	   *  if (Class.newArray) return Clazz.isAFloat(x);
	   */
	  {
	  }
	  return x instanceof Float[];
	...
	public static boolean isADD(Object x) {
	  /**
	   * @j2sNative
	   *  if (Class.newArray) return Clazz.isAFF(x);
	   */
	  {
	  }
	  return x instanceof double[][];
	...
	public static boolean isAB(Object x) {
	  /**
	   * @j2sNative
	   *  if (Class.newArray) return Clazz.isAB(x);
	   */
	  {
	  }
	...
	public static boolean isAI(Object x) {
	  /**
	   * @j2sNative
	   *  if (Class.newArray) return Clazz.isAI(x);
	   */
	  {
	  }
	...
	public static boolean isAII(Object x) {
	  /**
	   * @j2sNative
	   *  if (Class.newArray) return Clazz.isAII(x);
	   */
	  {
	  }
	  return (x instanceof int[][]);
	...
	public static boolean isAFFF(Object x) {
	  /**
	   * @j2sNative
	   *  if (Class.newArray) return Clazz.isAFFF(x);
	   */
	  {
	  }
	  return x instanceof float[][][];
