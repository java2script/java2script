...
Clazz.newMethod$ (C$, 'construct$charA', function (buf) {
...
Clazz.newMethod$ (C$, 'construct$charA$I$I', function (buf, offset, length) {
C$.superClazz.construct$O.apply(this, [buf]);
C$.$init$.apply(this);
...
Clazz.newMethod$ (C$, 'read$charA$I$I', function (buffer, offset, len) {
