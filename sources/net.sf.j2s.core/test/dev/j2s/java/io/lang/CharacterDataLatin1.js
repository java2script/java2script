...
var upperMap =  Clazz.newArray$(Character.TYPE, -1, [String.fromCharCode (ch)]);
if (ch == 0x00DF) {
...
Clazz.defineStatics$ (C$, ["sharpsMap",  Clazz.newArray$(Character.TYPE, -1, ['S', 'S']),
"instance", Clazz.$new(CharacterDataLatin1.construct,[]),
"A",  Clazz.newArray$(Integer.TYPE, [256]),
