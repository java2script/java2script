...
C$.$init$.apply(this);
this.buf =  Clazz.newArray$('BA', 1, [32]);
}, 1);
...
return;
}var newbuf =  Clazz.newArray$('BA', 1, [(this.count + i) * 2]);
...
var newArray =  Clazz.newArray$('BA', 1, [this.count]);
...
var newBuf =  Clazz.newArray$('CA', 1, [this.size ()]);
