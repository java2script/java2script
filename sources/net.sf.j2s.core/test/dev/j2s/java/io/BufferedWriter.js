...
if (C$.prototype.isOpen.apply(this, [])) {
if (this.pos > 0) {
this.out.write$CA$I$I (this.buf, 0, this.pos);
}this.pos = 0;
this.out.flush ();
} else {
...
this.out.write$CA$I$I (cbuf, offset, count);
return;
}var available = this.buf.length - this.pos;
if (count < available) {
available = count;
}if (available > 0) {
System.arraycopy$O$I$O$I$I (cbuf, offset, this.buf, this.pos, available);
this.pos += available;
}if (this.pos == this.buf.length) {
this.out.write$CA$I$I (this.buf, 0, this.buf.length);
this.pos = 0;
if (count > available) {
offset += available;
available = count - available;
if (available >= this.buf.length) {
this.out.write$CA$I$I (cbuf, offset, available);
return;
}System.arraycopy$O$I$O$I$I (cbuf, offset, this.buf, this.pos, available);
this.pos += available;
}}}});
...
str.getChars$I$I$CA$I (offset, offset + available, this.buf, this.pos);
this.pos += available;
}if (this.pos == this.buf.length) {
this.out.write$CA$I$I (this.buf, 0, this.buf.length);
this.pos = 0;
