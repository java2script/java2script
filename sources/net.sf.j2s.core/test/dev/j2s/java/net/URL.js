...
Clazz.load (["java.util.Hashtable"], "java.net.URL", ["java.lang.Character", "$.Error", "JU.AjaxURLConnection", "java.net.MalformedURLException", "$.Parts", "swingjs.JSToolkit"], function () {
...
Clazz.makeConstructor (c$, 
function (spec) {
this.construct (Clazz.castNullAs ("java.net.URL"), spec, null);
}, "~S");
Clazz.makeConstructor (c$, 
...
function () {
try {
return swingjs.JSToolkit.checkForJSData (this,  new java.net.URI (this.toString ()));
} catch (e) {
if (Clazz.exceptionOf (e, java.net.MalformedURLException)) {
return null;
} else {
...
function () {
var bis = JU.AjaxURLConnection.getAttachedStreamData (this);
