Clazz.load (["java.util.AbstractList", "$.List", "$.RandomAccess"], "java.util.Vector", ["java.lang.ArrayIndexOutOfBoundsException", "$.IllegalArgumentException", "$.IndexOutOfBoundsException", "$.StringBuffer", "java.util.Arrays", "$.Collections", "$.Enumeration", "$.NoSuchElementException"], function () {
;
...
if (count > 0) {
System.arraycopy$O$I$O$I$I (this.elementData, location, this.elementData, location + size, count);
}var it = collection.iterator ();
while (it.hasNext ()) {
...
System.arraycopy$O$I$O$I$I (this.elementData, 0, elements, 0, this.elementCount);
});
...
System.arraycopy$O$I$O$I$I (this.elementData, 0, newData, 0, this.elementCount);
...
if (count > 0) {
System.arraycopy$O$I$O$I$I (this.elementData, location, this.elementData, location + 1, count);
...
if (size > 0) {
System.arraycopy$O$I$O$I$I (this.elementData, location + 1, this.elementData, location, size);
...
System.arraycopy$O$I$O$I$I (this.elementData, end, this.elementData, start, this.elementCount - end);
...
contents = Clazz.newArray$ (ct, this.elementCount);
}System.arraycopy$O$I$O$I$I (this.elementData, 0, contents, 0, this.elementCount);
if (this.elementCount < contents.length) {
