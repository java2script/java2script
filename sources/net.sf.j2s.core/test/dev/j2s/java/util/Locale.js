...
if (length == 0) {
return "";
}var index = ",aaaar,ababk,afafr,amamh,arara,asasm,ayaym,azaze,babak,bebel,bgbul,bhbih,bibis,bnben,bobod,brbre,cacat,cocos,csces,cycym,dadan,dedeu,dzdzo,elell,eneng,eoepo,esspa,etest,eueus,fafas,fifin,fjfij,fofao,frfra,fyfry,gagai,gdgdh,glglg,gngrn,guguj,hahau,heheb,hihin,hrhrv,huhun,hyhye,iaina,idind,ieile,ikipk,inind,isisl,itita,iuiku,iwheb,jajpn,jiyid,jwjaw,kakat,kkkaz,klkal,kmkhm,knkan,kokor,kskas,kukur,kykir,lalat,lnlin,lolao,ltlit,lvlav,mgmlg,mimri,mkmkd,mlmal,mnmon,momol,mrmar,msmsa,mtmlt,mymya,nanau,nenep,nlnld,nonor,ococi,omorm,orori,papan,plpol,pspus,ptpor,quque,rmroh,rnrun,roron,rurus,rwkin,sasan,sdsnd,sgsag,shsrp,sisin,skslk,slslv,smsmo,snsna,sosom,sqsqi,srsrp,ssssw,stsot,susun,svswe,swswa,tatam,tetel,tgtgk,ththa,titir,tktuk,tltgl,tntsn,toton,trtur,tstso,tttat,twtwi,uguig,ukukr,ururd,uzuzb,vivie,vovol,wowol,xhxho,yiyid,yoyor,zazha,zhzho,zuzul".indexOf$S ("," + this.language);
if (index == -1 || length != 2) {
...
}return ",aaaar,ababk,afafr,amamh,arara,asasm,ayaym,azaze,babak,bebel,bgbul,bhbih,bibis,bnben,bobod,brbre,cacat,cocos,csces,cycym,dadan,dedeu,dzdzo,elell,eneng,eoepo,esspa,etest,eueus,fafas,fifin,fjfij,fofao,frfra,fyfry,gagai,gdgdh,glglg,gngrn,guguj,hahau,heheb,hihin,hrhrv,huhun,hyhye,iaina,idind,ieile,ikipk,inind,isisl,itita,iuiku,iwheb,jajpn,jiyid,jwjaw,kakat,kkkaz,klkal,kmkhm,knkan,kokor,kskas,kukur,kykir,lalat,lnlin,lolao,ltlit,lvlav,mgmlg,mimri,mkmkd,mlmal,mnmon,momol,mrmar,msmsa,mtmlt,mymya,nanau,nenep,nlnld,nonor,ococi,omorm,orori,papan,plpol,pspus,ptpor,quque,rmroh,rnrun,roron,rurus,rwkin,sasan,sdsnd,sgsag,shsrp,sisin,skslk,slslv,smsmo,snsna,sosom,sqsqi,srsrp,ssssw,stsot,susun,svswe,swswa,tatam,tetel,tgtgk,ththa,titir,tktuk,tltgl,tntsn,toton,trtur,tstso,tttat,twtwi,uguig,ukukr,ururd,uzuzb,vivie,vovol,wowol,xhxho,yiyid,yoyor,zazha,zhzho,zuzul".substring$I$I (index + 3, index + 6);
});
...
Clazz.defineStatics$ (C$, ["ENGLISH", Clazz.$new(java.util.Locale.construct$S$S$S,["en", "", ""]),
"FRENCH", Clazz.$new(java.util.Locale.construct$S$S$S,["fr", "", ""]),
"GERMAN", Clazz.$new(java.util.Locale.construct$S$S$S,["de", "", ""]),
"ITALIAN", Clazz.$new(java.util.Locale.construct$S$S$S,["it", "", ""]),
"JAPANESE", Clazz.$new(java.util.Locale.construct$S$S$S,["ja", "", ""]),
"KOREAN", Clazz.$new(java.util.Locale.construct$S$S$S,["ko", "", ""]),
"CHINESE", Clazz.$new(java.util.Locale.construct$S$S$S,["zh", "", ""]),
"SIMPLIFIED_CHINESE", Clazz.$new(java.util.Locale.construct$S$S$S,["zh", "CN", ""]),
"TRADITIONAL_CHINESE", Clazz.$new(java.util.Locale.construct$S$S$S,["zh", "TW", ""]),
"FRANCE", Clazz.$new(java.util.Locale.construct$S$S$S,["fr", "FR", ""]),
"GERMANY", Clazz.$new(java.util.Locale.construct$S$S$S,["de", "DE", ""]),
"ITALY", Clazz.$new(java.util.Locale.construct$S$S$S,["it", "IT", ""]),
"JAPAN", Clazz.$new(java.util.Locale.construct$S$S$S,["ja", "JP", ""]),
"KOREA", Clazz.$new(java.util.Locale.construct$S$S$S,["ko", "KR", ""]),
"CHINA", Clazz.$new(java.util.Locale.construct$S$S$S,["zh", "CN", ""]),
"PRC", Clazz.$new(java.util.Locale.construct$S$S$S,["zh", "CN", ""]),
"TAIWAN", Clazz.$new(java.util.Locale.construct$S$S$S,["zh", "TW", ""]),
"UK", Clazz.$new(java.util.Locale.construct$S$S$S,["en", "GB", ""]),
"US", Clazz.$new(java.util.Locale.construct$S$S$S,["en", "US", ""]),
"CANADA", Clazz.$new(java.util.Locale.construct$S$S$S,["en", "CA", ""]),
"CANADA_FRENCH", Clazz.$new(java.util.Locale.construct$S$S$S,["fr", "CA", ""]),
"defaultLocale", null,
"isoLanguages", null,
