...
}var result =  Clazz.newArray$('SA', 1, [java.util.Locale.isoCountries.length]);
...
}var result =  Clazz.newArray$('SA', 1, [java.util.Locale.isoLanguages.length]);
...
"ENGLISH", Clazz.$new(java.util.Locale.construct$S$S$S,["en", "", ""]),
