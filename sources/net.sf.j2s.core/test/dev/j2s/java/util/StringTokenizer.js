...
C$.construct$S$S$b.apply(this, [string, " \t\n\r\f", false]);
}, 1);

Clazz.newMethod$ (C$, 'construct$S$S', function (string, delimiters) {
C$.construct$S$S$b.apply(this, [string, delimiters, false]);
}, 1);

Clazz.newMethod$ (C$, 'construct$S$S$b', function (string, delimiters, returnDelimiters) {
C$.$init$.apply(this);
if (string != null) {
this.string = string;
