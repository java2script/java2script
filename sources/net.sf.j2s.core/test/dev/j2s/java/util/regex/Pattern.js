...
flagStr += "i";
}var pattern = Clazz.$new(java.util.regex.Pattern.construct);
{
...
return java.util.regex.Pattern.compile$S (regex).matcher$CharSequence (input).matches ();
}, 1);

Clazz.newMethod$ (C$, 'quote$S', function (s) {
var sb = Clazz.$new(StringBuffer.construct).append ("\\Q");
var apos = 0;
var k;
