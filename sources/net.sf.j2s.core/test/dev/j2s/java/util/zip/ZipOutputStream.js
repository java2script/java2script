...
Clazz.load (["java.util.zip.DeflaterOutputStream", "$.ZipConstants", "java.util.Hashtable", "JU.Lst", "java.util.zip.CRC32"], "java.util.zip.ZipOutputStream", ["java.io.IOException", "java.lang.Boolean", "$.IllegalArgumentException", "$.IndexOutOfBoundsException", "$.Long", "java.util.zip.ZipException", "swingjs.jzlib.ZStream"], function () {
...
function (out) {
this.setDOS (out, java.util.zip.DeflaterOutputStream.newDeflater ());
return this;
}, "java.io.OutputStream");
Clazz.defineMethod (c$, "setComment", 
function (comment) {
if (comment != null) {
this.comment = swingjs.jzlib.ZStream.getBytes (comment);
...
this.writeEXT (e);
}this.deflater = java.util.zip.DeflaterOutputStream.newDeflater ();
...
}}var nameBytes = swingjs.jzlib.ZStream.getBytes (e.name);
...
if (e.comment != null) {
commentBytes = swingjs.jzlib.ZStream.getBytes (e.comment);
