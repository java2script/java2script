...
Clazz.load(["java.util.AbstractMap","$.AbstractSet","$.Iterator","$.Map","$.MapEntry"],"java.util.concurrent.ConcurrentHashMap",["java.lang.IllegalArgumentException","$.IllegalStateException","java.util.AbstractCollection","$.Arrays","$.ConcurrentModificationException","java.util.MapEntry.Type","java.util.NoSuchElementException"],function(){
...
//Clazz.makeConstructor(c$,
//function(capacity){
//Clazz.superConstructor(this,java.util.ConcurrentHashMap,[]);
//if(capacity>=0){
//this.elementCount=0;
...
Clazz.makeConstructor(c$,
function(capacity){
Clazz.superConstructor(this,java.util.concurrent.ConcurrentHashMap,[]);
if(capacity>=0){
this.elementCount=0;
this.elementData=this.newElementArray(capacity==0?1:capacity);
this.loadFactor=0.75;
...
Clazz.superCall(this,java.util.concurrent.ConcurrentHashMap,"putAll",[map]);
},"java.util.Map");
...
//function(map){
//this.construct(map.size()<6?11:map.size()*2);
//Clazz.superCall(this,java.util.ConcurrentHashMap,"putAll",[map]);
//},"java.util.Map");
...
function(){
try{
var map=this.cloneAM();//Clazz.superCall(this,java.util.concurrent.ConcurrentHashMap,"clone",[]);
...
function(){
if(this.$keySet==null){
this.$keySet=((Clazz.isClassDefined("java.util.concurrent.ConcurrentHashMap$1")?0:java.util.concurrent.ConcurrentHashMap.$ConcurrentHashMap$1$()),Clazz.innerTypeInstance(java.util.concurrent.ConcurrentHashMap$1,this,null));
}return this.$keySet;
});
...
this.valuesCollection=((Clazz.isClassDefined("java.util.concurrent.ConcurrentHashMap$2")?0:java.util.concurrent.ConcurrentHashMap.$ConcurrentHashMap$2$()),Clazz.innerTypeInstance(java.util.concurrent.ConcurrentHashMap$2,this,null));
...
Clazz.makeConstructor(c$,
function(a,b){
Clazz.superConstructor(this,java.util.concurrent.ConcurrentHashMap.Entry,[a,b]);
this.origKeyHash=(a==null?0:a.hashCode());
},"~O,~O");
Clazz.defineMethod(c$,"clone",
function(){
var a=Clazz.superCall(this,java.util.concurrent.ConcurrentHashMap.Entry,"clone",[]);
if(this.next!=null){
...
Clazz.makeConstructor(c$,
function(a){
Clazz.superConstructor(this,java.util.concurrent.ConcurrentHashMap.ConcurrentHashMapEntrySet,[]);
