...
var buf =  Clazz.newArray$('CA', -1, [-1, [this.value]]);
...
return  Clazz.newArray$('CA', -1, [-1, [String.fromCharCode (codePoint)]]);
}var result =  Clazz.newArray$('CA', 1, [2]);
...
"map", Clazz.$new(java.util.HashMap.construct,[]),
"BASIC_LATIN", Clazz.$new(Character.UnicodeBlock.construct,["BASIC_LATIN",  Clazz.newArray$('SA', -1, [-1, ["Basic Latin", "BasicLatin"]])]),
"LATIN_1_SUPPLEMENT", Clazz.$new(Character.UnicodeBlock.construct,["LATIN_1_SUPPLEMENT",  Clazz.newArray$('SA', -1, [-1, ["Latin-1 Supplement", "Latin-1Supplement"]])]),
"LATIN_EXTENDED_A", Clazz.$new(Character.UnicodeBlock.construct,["LATIN_EXTENDED_A",  Clazz.newArray$('SA', -1, [-1, ["Latin Extended-A", "LatinExtended-A"]])]),
"LATIN_EXTENDED_B", Clazz.$new(Character.UnicodeBlock.construct,["LATIN_EXTENDED_B",  Clazz.newArray$('SA', -1, [-1, ["Latin Extended-B", "LatinExtended-B"]])]),
"IPA_EXTENSIONS", Clazz.$new(Character.UnicodeBlock.construct,["IPA_EXTENSIONS",  Clazz.newArray$('SA', -1, [-1, ["IPA Extensions", "IPAExtensions"]])]),
"SPACING_MODIFIER_LETTERS", Clazz.$new(Character.UnicodeBlock.construct,["SPACING_MODIFIER_LETTERS",  Clazz.newArray$('SA', -1, [-1, ["Spacing Modifier Letters", "SpacingModifierLetters"]])]),
"COMBINING_DIACRITICAL_MARKS", Clazz.$new(Character.UnicodeBlock.construct,["COMBINING_DIACRITICAL_MARKS",  Clazz.newArray$('SA', -1, [-1, ["Combining Diacritical Marks", "CombiningDiacriticalMarks"]])]),
"GREEK", Clazz.$new(Character.UnicodeBlock.construct,["GREEK",  Clazz.newArray$('SA', -1, [-1, ["Greek and Coptic", "GreekandCoptic"]])]),
...
"HANGUL_JAMO", Clazz.$new(Character.UnicodeBlock.construct,["HANGUL_JAMO",  Clazz.newArray$('SA', -1, [-1, ["Hangul Jamo", "HangulJamo"]])]),
"LATIN_EXTENDED_ADDITIONAL", Clazz.$new(Character.UnicodeBlock.construct,["LATIN_EXTENDED_ADDITIONAL",  Clazz.newArray$('SA', -1, [-1, ["Latin Extended Additional", "LatinExtendedAdditional"]])]),
"GREEK_EXTENDED", Clazz.$new(Character.UnicodeBlock.construct,["GREEK_EXTENDED",  Clazz.newArray$('SA', -1, [-1, ["Greek Extended", "GreekExtended"]])]),
"GENERAL_PUNCTUATION", Clazz.$new(Character.UnicodeBlock.construct,["GENERAL_PUNCTUATION",  Clazz.newArray$('SA', -1, [-1, ["General Punctuation", "GeneralPunctuation"]])]),
"SUPERSCRIPTS_AND_SUBSCRIPTS", Clazz.$new(Character.UnicodeBlock.construct,["SUPERSCRIPTS_AND_SUBSCRIPTS",  Clazz.newArray$('SA', -1, [-1, ["Superscripts and Subscripts", "SuperscriptsandSubscripts"]])]),
"CURRENCY_SYMBOLS", Clazz.$new(Character.UnicodeBlock.construct,["CURRENCY_SYMBOLS",  Clazz.newArray$('SA', -1, [-1, ["Currency Symbols", "CurrencySymbols"]])]),
"COMBINING_MARKS_FOR_SYMBOLS", Clazz.$new(Character.UnicodeBlock.construct,["COMBINING_MARKS_FOR_SYMBOLS",  Clazz.newArray$('SA', -1, [-1, ["Combining Diacritical Marks for Symbols", "CombiningDiacriticalMarksforSymbols", "Combining Marks for Symbols", "CombiningMarksforSymbols"]])]),
"LETTERLIKE_SYMBOLS", Clazz.$new(Character.UnicodeBlock.construct,["LETTERLIKE_SYMBOLS",  Clazz.newArray$('SA', -1, [-1, ["Letterlike Symbols", "LetterlikeSymbols"]])]),
"NUMBER_FORMS", Clazz.$new(Character.UnicodeBlock.construct,["NUMBER_FORMS",  Clazz.newArray$('SA', -1, [-1, ["Number Forms", "NumberForms"]])]),
"ARROWS", Clazz.$new(Character.UnicodeBlock.construct,["ARROWS"]),
"MATHEMATICAL_OPERATORS", Clazz.$new(Character.UnicodeBlock.construct,["MATHEMATICAL_OPERATORS",  Clazz.newArray$('SA', -1, [-1, ["Mathematical Operators", "MathematicalOperators"]])]),
"MISCELLANEOUS_TECHNICAL", Clazz.$new(Character.UnicodeBlock.construct,["MISCELLANEOUS_TECHNICAL",  Clazz.newArray$('SA', -1, [-1, ["Miscellaneous Technical", "MiscellaneousTechnical"]])]),
"CONTROL_PICTURES", Clazz.$new(Character.UnicodeBlock.construct,["CONTROL_PICTURES",  Clazz.newArray$('SA', -1, [-1, ["Control Pictures", "ControlPictures"]])]),
"OPTICAL_CHARACTER_RECOGNITION", Clazz.$new(Character.UnicodeBlock.construct,["OPTICAL_CHARACTER_RECOGNITION",  Clazz.newArray$('SA', -1, [-1, ["Optical Character Recognition", "OpticalCharacterRecognition"]])]),
"ENCLOSED_ALPHANUMERICS", Clazz.$new(Character.UnicodeBlock.construct,["ENCLOSED_ALPHANUMERICS",  Clazz.newArray$('SA', -1, [-1, ["Enclosed Alphanumerics", "EnclosedAlphanumerics"]])]),
"BOX_DRAWING", Clazz.$new(Character.UnicodeBlock.construct,["BOX_DRAWING",  Clazz.newArray$('SA', -1, [-1, ["Box Drawing", "BoxDrawing"]])]),
"BLOCK_ELEMENTS", Clazz.$new(Character.UnicodeBlock.construct,["BLOCK_ELEMENTS",  Clazz.newArray$('SA', -1, [-1, ["Block Elements", "BlockElements"]])]),
"GEOMETRIC_SHAPES", Clazz.$new(Character.UnicodeBlock.construct,["GEOMETRIC_SHAPES",  Clazz.newArray$('SA', -1, [-1, ["Geometric Shapes", "GeometricShapes"]])]),
"MISCELLANEOUS_SYMBOLS", Clazz.$new(Character.UnicodeBlock.construct,["MISCELLANEOUS_SYMBOLS",  Clazz.newArray$('SA', -1, [-1, ["Miscellaneous Symbols", "MiscellaneousSymbols"]])]),
"DINGBATS", Clazz.$new(Character.UnicodeBlock.construct,["DINGBATS"]),
"CJK_SYMBOLS_AND_PUNCTUATION", Clazz.$new(Character.UnicodeBlock.construct,["CJK_SYMBOLS_AND_PUNCTUATION",  Clazz.newArray$('SA', -1, [-1, ["CJK Symbols and Punctuation", "CJKSymbolsandPunctuation"]])]),
...
"HANGUL_COMPATIBILITY_JAMO", Clazz.$new(Character.UnicodeBlock.construct,["HANGUL_COMPATIBILITY_JAMO",  Clazz.newArray$('SA', -1, [-1, ["Hangul Compatibility Jamo", "HangulCompatibilityJamo"]])]),
"KANBUN", Clazz.$new(Character.UnicodeBlock.construct,["KANBUN"]),
"ENCLOSED_CJK_LETTERS_AND_MONTHS", Clazz.$new(Character.UnicodeBlock.construct,["ENCLOSED_CJK_LETTERS_AND_MONTHS",  Clazz.newArray$('SA', -1, [-1, ["Enclosed CJK Letters and Months", "EnclosedCJKLettersandMonths"]])]),
"CJK_COMPATIBILITY", Clazz.$new(Character.UnicodeBlock.construct,["CJK_COMPATIBILITY",  Clazz.newArray$('SA', -1, [-1, ["CJK Compatibility", "CJKCompatibility"]])]),
"CJK_UNIFIED_IDEOGRAPHS", Clazz.$new(Character.UnicodeBlock.construct,["CJK_UNIFIED_IDEOGRAPHS",  Clazz.newArray$('SA', -1, [-1, ["CJK Unified Ideographs", "CJKUnifiedIdeographs"]])]),
"HANGUL_SYLLABLES", Clazz.$new(Character.UnicodeBlock.construct,["HANGUL_SYLLABLES",  Clazz.newArray$('SA', -1, [-1, ["Hangul Syllables", "HangulSyllables"]])]),
"PRIVATE_USE_AREA", Clazz.$new(Character.UnicodeBlock.construct,["PRIVATE_USE_AREA",  Clazz.newArray$('SA', -1, [-1, ["Private Use Area", "PrivateUseArea"]])]),
"CJK_COMPATIBILITY_IDEOGRAPHS", Clazz.$new(Character.UnicodeBlock.construct,["CJK_COMPATIBILITY_IDEOGRAPHS",  Clazz.newArray$('SA', -1, [-1, ["CJK Compatibility Ideographs", "CJKCompatibilityIdeographs"]])]),
"ALPHABETIC_PRESENTATION_FORMS", Clazz.$new(Character.UnicodeBlock.construct,["ALPHABETIC_PRESENTATION_FORMS",  Clazz.newArray$('SA', -1, [-1, ["Alphabetic Presentation Forms", "AlphabeticPresentationForms"]])]),
"ARABIC_PRESENTATION_FORMS_A", Clazz.$new(Character.UnicodeBlock.construct,["ARABIC_PRESENTATION_FORMS_A",  Clazz.newArray$('SA', -1, [-1, ["Arabic Presentation Forms-A", "ArabicPresentationForms-A"]])]),
"COMBINING_HALF_MARKS", Clazz.$new(Character.UnicodeBlock.construct,["COMBINING_HALF_MARKS",  Clazz.newArray$('SA', -1, [-1, ["Combining Half Marks", "CombiningHalfMarks"]])]),
"CJK_COMPATIBILITY_FORMS", Clazz.$new(Character.UnicodeBlock.construct,["CJK_COMPATIBILITY_FORMS",  Clazz.newArray$('SA', -1, [-1, ["CJK Compatibility Forms", "CJKCompatibilityForms"]])]),
"SMALL_FORM_VARIANTS", Clazz.$new(Character.UnicodeBlock.construct,["SMALL_FORM_VARIANTS",  Clazz.newArray$('SA', -1, [-1, ["Small Form Variants", "SmallFormVariants"]])]),
"ARABIC_PRESENTATION_FORMS_B", Clazz.$new(Character.UnicodeBlock.construct,["ARABIC_PRESENTATION_FORMS_B",  Clazz.newArray$('SA', -1, [-1, ["Arabic Presentation Forms-B", "ArabicPresentationForms-B"]])]),
"HALFWIDTH_AND_FULLWIDTH_FORMS", Clazz.$new(Character.UnicodeBlock.construct,["HALFWIDTH_AND_FULLWIDTH_FORMS",  Clazz.newArray$('SA', -1, [-1, ["Halfwidth and Fullwidth Forms", "HalfwidthandFullwidthForms"]])]),
...
"UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS", Clazz.$new(Character.UnicodeBlock.construct,["UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS",  Clazz.newArray$('SA', -1, [-1, ["Unified Canadian Aboriginal Syllabics", "UnifiedCanadianAboriginalSyllabics"]])]),
...
"BRAILLE_PATTERNS", Clazz.$new(Character.UnicodeBlock.construct,["BRAILLE_PATTERNS",  Clazz.newArray$('SA', -1, [-1, ["Braille Patterns", "BraillePatterns"]])]),
"CJK_RADICALS_SUPPLEMENT", Clazz.$new(Character.UnicodeBlock.construct,["CJK_RADICALS_SUPPLEMENT",  Clazz.newArray$('SA', -1, [-1, ["CJK Radicals Supplement", "CJKRadicalsSupplement"]])]),
"KANGXI_RADICALS", Clazz.$new(Character.UnicodeBlock.construct,["KANGXI_RADICALS",  Clazz.newArray$('SA', -1, [-1, ["Kangxi Radicals", "KangxiRadicals"]])]),
"IDEOGRAPHIC_DESCRIPTION_CHARACTERS", Clazz.$new(Character.UnicodeBlock.construct,["IDEOGRAPHIC_DESCRIPTION_CHARACTERS",  Clazz.newArray$('SA', -1, [-1, ["Ideographic Description Characters", "IdeographicDescriptionCharacters"]])]),
"BOPOMOFO_EXTENDED", Clazz.$new(Character.UnicodeBlock.construct,["BOPOMOFO_EXTENDED",  Clazz.newArray$('SA', -1, [-1, ["Bopomofo Extended", "BopomofoExtended"]])]),
"CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A", Clazz.$new(Character.UnicodeBlock.construct,["CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A",  Clazz.newArray$('SA', -1, [-1, ["CJK Unified Ideographs Extension A", "CJKUnifiedIdeographsExtensionA"]])]),
"YI_SYLLABLES", Clazz.$new(Character.UnicodeBlock.construct,["YI_SYLLABLES",  Clazz.newArray$('SA', -1, [-1, ["Yi Syllables", "YiSyllables"]])]),
"YI_RADICALS", Clazz.$new(Character.UnicodeBlock.construct,["YI_RADICALS",  Clazz.newArray$('SA', -1, [-1, ["Yi Radicals", "YiRadicals"]])]),
"CYRILLIC_SUPPLEMENTARY", Clazz.$new(Character.UnicodeBlock.construct,["CYRILLIC_SUPPLEMENTARY",  Clazz.newArray$('SA', -1, [-1, ["Cyrillic Supplementary", "CyrillicSupplementary"]])]),
...
"TAI_LE", Clazz.$new(Character.UnicodeBlock.construct,["TAI_LE",  Clazz.newArray$('SA', -1, [-1, ["Tai Le", "TaiLe"]])]),
"KHMER_SYMBOLS", Clazz.$new(Character.UnicodeBlock.construct,["KHMER_SYMBOLS",  Clazz.newArray$('SA', -1, [-1, ["Khmer Symbols", "KhmerSymbols"]])]),
"PHONETIC_EXTENSIONS", Clazz.$new(Character.UnicodeBlock.construct,["PHONETIC_EXTENSIONS",  Clazz.newArray$('SA', -1, [-1, ["Phonetic Extensions", "PhoneticExtensions"]])]),
"MISCELLANEOUS_MATHEMATICAL_SYMBOLS_A", Clazz.$new(Character.UnicodeBlock.construct,["MISCELLANEOUS_MATHEMATICAL_SYMBOLS_A",  Clazz.newArray$('SA', -1, [-1, ["Miscellaneous Mathematical Symbols-A", "MiscellaneousMathematicalSymbols-A"]])]),
"SUPPLEMENTAL_ARROWS_A", Clazz.$new(Character.UnicodeBlock.construct,["SUPPLEMENTAL_ARROWS_A",  Clazz.newArray$('SA', -1, [-1, ["Supplemental Arrows-A", "SupplementalArrows-A"]])]),
"SUPPLEMENTAL_ARROWS_B", Clazz.$new(Character.UnicodeBlock.construct,["SUPPLEMENTAL_ARROWS_B",  Clazz.newArray$('SA', -1, [-1, ["Supplemental Arrows-B", "SupplementalArrows-B"]])]),
"MISCELLANEOUS_MATHEMATICAL_SYMBOLS_B", Clazz.$new(Character.UnicodeBlock.construct,["MISCELLANEOUS_MATHEMATICAL_SYMBOLS_B",  Clazz.newArray$('SA', -1, [-1, ["Miscellaneous Mathematical Symbols-B", "MiscellaneousMathematicalSymbols-B"]])]),
"SUPPLEMENTAL_MATHEMATICAL_OPERATORS", Clazz.$new(Character.UnicodeBlock.construct,["SUPPLEMENTAL_MATHEMATICAL_OPERATORS",  Clazz.newArray$('SA', -1, [-1, ["Supplemental Mathematical Operators", "SupplementalMathematicalOperators"]])]),
"MISCELLANEOUS_SYMBOLS_AND_ARROWS", Clazz.$new(Character.UnicodeBlock.construct,["MISCELLANEOUS_SYMBOLS_AND_ARROWS",  Clazz.newArray$('SA', -1, [-1, ["Miscellaneous Symbols and Arrows", "MiscellaneousSymbolsandArrows"]])]),
"KATAKANA_PHONETIC_EXTENSIONS", Clazz.$new(Character.UnicodeBlock.construct,["KATAKANA_PHONETIC_EXTENSIONS",  Clazz.newArray$('SA', -1, [-1, ["Katakana Phonetic Extensions", "KatakanaPhoneticExtensions"]])]),
"YIJING_HEXAGRAM_SYMBOLS", Clazz.$new(Character.UnicodeBlock.construct,["YIJING_HEXAGRAM_SYMBOLS",  Clazz.newArray$('SA', -1, [-1, ["Yijing Hexagram Symbols", "YijingHexagramSymbols"]])]),
"VARIATION_SELECTORS", Clazz.$new(Character.UnicodeBlock.construct,["VARIATION_SELECTORS",  Clazz.newArray$('SA', -1, [-1, ["Variation Selectors", "VariationSelectors"]])]),
"LINEAR_B_SYLLABARY", Clazz.$new(Character.UnicodeBlock.construct,["LINEAR_B_SYLLABARY",  Clazz.newArray$('SA', -1, [-1, ["Linear B Syllabary", "LinearBSyllabary"]])]),
"LINEAR_B_IDEOGRAMS", Clazz.$new(Character.UnicodeBlock.construct,["LINEAR_B_IDEOGRAMS",  Clazz.newArray$('SA', -1, [-1, ["Linear B Ideograms", "LinearBIdeograms"]])]),
"AEGEAN_NUMBERS", Clazz.$new(Character.UnicodeBlock.construct,["AEGEAN_NUMBERS",  Clazz.newArray$('SA', -1, [-1, ["Aegean Numbers", "AegeanNumbers"]])]),
"OLD_ITALIC", Clazz.$new(Character.UnicodeBlock.construct,["OLD_ITALIC",  Clazz.newArray$('SA', -1, [-1, ["Old Italic", "OldItalic"]])]),
...
Clazz.defineStatics (C$,
"cache",  Clazz.newArray$('CharacterA', 1, [128]));
{
