...
if (val == null) val =  Clazz.newArray$('CA', 1, [0]);
...
this.shared = false;
this.value =  Clazz.newArray$('CA', 1, [this.count + 16]);
...
var newData =  Clazz.newArray$('CA', 1, [min > twice ? min : twice]);
...
var newData =  Clazz.newArray$('CA', 1, [this.value.length]);
...
newSize = a > b ? a : b;
}var newData =  Clazz.newArray$('CA', 1, [newSize]);
...
if (this.count < this.value.length) {
var newValue =  Clazz.newArray$('CA', 1, [this.count]);
