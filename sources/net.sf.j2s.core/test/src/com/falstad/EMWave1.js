...
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.EMWave1Frame'))).c$$com_falstad_EMWave1,[null]);
C$.ogf.init();
}, 1);
...
if (C$.ogf == null ) {
this.started = true;
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.EMWave1Frame'))).c$$com_falstad_EMWave1,[this]);
C$.ogf.init();
this.repaint();
}});
