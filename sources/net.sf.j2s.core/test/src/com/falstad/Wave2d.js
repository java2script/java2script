...
var C$=Clazz.newClass(P$, "Wave2d", null, 'a2s.Applet', 'java.awt.event.ComponentListener');
C$.ogf = null;
...
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.Wave2dFrame'))).c$$com_falstad_Wave2d,[null]);
C$.ogf.initFrame();
}, 1);
...
if (C$.ogf == null ) {
this.started = true;
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.Wave2dFrame'))).c$$com_falstad_Wave2d,[this]);
C$.ogf.initFrame();
this.repaint();
}});
