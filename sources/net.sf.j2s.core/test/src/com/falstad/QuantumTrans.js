...
var C$=Clazz.newClass(P$, "QuantumTrans", null, 'a2s.Applet', 'java.awt.event.ComponentListener');
C$.qf = null;
...
C$.qf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.QuantumTransFrame'))).c$$com_falstad_QuantumTrans,[null]);
C$.qf.init();
}, 1);
...
if (C$.qf == null ) {
this.started = true;
C$.qf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.QuantumTransFrame'))).c$$com_falstad_QuantumTrans,[this]);
C$.qf.init();
this.repaint();
}});
