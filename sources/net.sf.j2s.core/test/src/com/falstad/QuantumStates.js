...
if (C$.qf == null ) {
this.started = true;
C$.qf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.QuantumStatesFrame'))).c$$com_falstad_QuantumStates,[this]);
C$.qf.init();
this.repaint();
}});

Clazz.newMeth(C$, 'main', function (args) {
C$.qf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.QuantumStatesFrame'))).c$$com_falstad_QuantumStates,[null]);
C$.qf.init();
}, 1);
