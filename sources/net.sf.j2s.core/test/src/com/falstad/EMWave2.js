...
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.EMWave2Frame'))).c$$com_falstad_EMWave2,[null]);
C$.ogf.init();
}, 1);
...
if (C$.ogf == null ) {
this.started = true;
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.EMWave2Frame'))).c$$com_falstad_EMWave2,[this]);
C$.ogf.init();
this.repaint();
}});
