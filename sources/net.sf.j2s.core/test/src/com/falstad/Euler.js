...
var C$=Clazz.newClass(P$, "Euler", null, 'a2s.Applet', 'java.awt.event.ComponentListener');
...
if (this.ogf == null ) {
this.started = true;
this.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.EulerFrame'))).c$$com_falstad_Euler,[this]);
this.ogf.init();
this.repaint();
}});
