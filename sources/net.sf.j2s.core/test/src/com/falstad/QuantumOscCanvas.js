...
var C$=Clazz.newClass(P$, "QuantumOscCanvas", null, 'a2s.Canvas');
...
Clazz.newMeth(C$, 'c$$com_falstad_QuantumOscFrame', function (p) {
...
this.pg.updateQuantumOsc$java_awt_Graphics(g);
});
