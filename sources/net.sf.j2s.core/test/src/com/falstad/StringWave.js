...
var C$=Clazz.newClass(P$, "StringWave", null, 'a2s.Applet', 'java.awt.event.ComponentListener');
C$.ogf = null;
...
C$.ogf = Clazz.new_((I$[0]||(I$[0]=Clazz.load('com.falstad.StringWaveFrame'))).c$$com_falstad_StringWave,[null]);
C$.ogf.init();
}, 1);
...
if (C$.ogf == null ) {
this.started = true;
C$.ogf = Clazz.new_((I$[0]||(I$[0]=Clazz.load('com.falstad.StringWaveFrame'))).c$$com_falstad_StringWave,[this]);
C$.ogf.init();
this.repaint();
}});
