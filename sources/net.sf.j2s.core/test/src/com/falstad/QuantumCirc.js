...
var C$=Clazz.newClass(P$, "QuantumCirc", null, 'a2s.Applet', 'java.awt.event.ComponentListener');
C$.ogf = null;
...
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.QuantumCircFrame'))).c$$com_falstad_QuantumCirc,[null]);
C$.ogf.init();
}, 1);
...
if (C$.ogf == null ) {
this.started = true;
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.QuantumCircFrame'))).c$$com_falstad_QuantumCirc,[this]);
C$.ogf.init();
this.repaint();
}});
