...
var C$=Clazz.newClass(P$, "AtomViewer", null, 'a2s.Applet', 'java.awt.event.ComponentListener');
C$.ogf = null;
...
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.AtomViewerFrame'))).c$$com_falstad_AtomViewer,[null]);
C$.ogf.init();
}, 1);
...
if (C$.ogf == null ) {
this.started = true;
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.AtomViewerFrame'))).c$$com_falstad_AtomViewer,[this]);
C$.ogf.init();
this.repaint();
}});
