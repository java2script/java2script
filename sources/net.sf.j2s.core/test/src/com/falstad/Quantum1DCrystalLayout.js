...
var C$=Clazz.newClass(P$, "Quantum1DCrystalLayout", null, null, 'java.awt.LayoutManager');
...
if (m.isVisible()) {
var d = m.getPreferredSize();
if (Clazz.instanceOf(m, "a2s.Scrollbar") || Clazz.instanceOf(m, "com.falstad.DecentScrollbar") ) d.width = barwidth;
