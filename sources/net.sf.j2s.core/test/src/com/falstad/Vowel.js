...
C$.ogf = Clazz.new_((I$[0]||(I$[0]=Clazz.load('com.falstad.VowelFrame'))).c$$com_falstad_Vowel,[null]);
C$.ogf.init();
}, 1);
...
this.started = true;
try {
C$.ogf = Clazz.new_((I$[0]||(I$[0]=Clazz.load('com.falstad.VowelFrame'))).c$$com_falstad_Vowel,[this]);
C$.ogf.init();
} catch (e) {
