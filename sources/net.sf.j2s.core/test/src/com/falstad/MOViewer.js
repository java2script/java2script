...
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.MOViewerFrame'))).c$$com_falstad_MOViewer,[null]);
C$.ogf.init();
}, 1);
...
if (C$.ogf == null ) {
this.started = true;
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.MOViewerFrame'))).c$$com_falstad_MOViewer,[this]);
C$.ogf.init();
this.repaint();
}});
