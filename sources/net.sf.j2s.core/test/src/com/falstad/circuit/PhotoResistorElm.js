...
(I$[0]||(I$[0]=Clazz.load('com.falstad.circuit.CircuitElm'))).sim.main.add$java_awt_Component(this.label = Clazz.new_((I$[1]||(I$[1]=Clazz.load('a2s.Label'))).c$$S$I,["Light Level", 0]));
var value = 50;
