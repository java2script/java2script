...
var C$=Clazz.newClass(P$, "InvertingSchmittElm", null, 'com.falstad.circuit.CircuitElm');
...
return C$.superclazz.prototype.dump.apply(this, []) + " " + new Double(this.slewRate).toString() + " " + new Double(this.lowerTrigger).toString() + " " + new Double(this.upperTrigger).toString() ;
});
...
this.interpPoint2$java_awt_Point$java_awt_Point$java_awt_Point$java_awt_Point$D$D(this.lead1, this.lead2, symPoints[5], symPoints[4], 0.2, (hs/4|0));
this.interpPoint2$java_awt_Point$java_awt_Point$java_awt_Point$java_awt_Point$D$D(this.lead1, this.lead2, symPoints[1], symPoints[2], 0.35, (hs/4|0));
this.interpPoint2$java_awt_Point$java_awt_Point$java_awt_Point$java_awt_Point$D$D(this.lead1, this.lead2, symPoints[0], dummy, 0.1, (hs/4|0));
this.interpPoint2$java_awt_Point$java_awt_Point$java_awt_Point$java_awt_Point$D$D(this.lead1, this.lead2, dummy, symPoints[3], 0.45, (hs/4|0));
...
return Clazz.new_((I$[2]||(I$[2]=Clazz.load('com.falstad.circuit.EditInfo'))).c$$S$D$D$D,["Lower threshold (V)", this.lowerTrigger, 0.01, 5]);
}if (n == 1) {
this.dut = this.upperTrigger;
return Clazz.new_((I$[2]||(I$[2]=Clazz.load('com.falstad.circuit.EditInfo'))).c$$S$D$D$D,["Upper threshold (V)", this.upperTrigger, 0.01, 5]);
}if (n == 2) return Clazz.new_((I$[2]||(I$[2]=Clazz.load('com.falstad.circuit.EditInfo'))).c$$S$D$D$D,["Slew Rate (V/ns)", this.slewRate, 0, 0]);
return null;
});
