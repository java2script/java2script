...
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.CircOscFrame'))).c$$com_falstad_CircOsc,[null]);
C$.ogf.init();
}, 1);
...
this.started = true;
try {
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.CircOscFrame'))).c$$com_falstad_CircOsc,[this]);
C$.ogf.init();
} catch (e) {
