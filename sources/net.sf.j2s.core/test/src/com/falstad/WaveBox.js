...
var C$=Clazz.newClass(P$, "WaveBox", null, 'a2s.Applet', 'java.awt.event.ComponentListener');
C$.ogf = null;
...
{
}C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.WaveBoxFrame'))).c$$com_falstad_WaveBox,[null]);
C$.ogf.initFrame();
}, 1);
...
if (C$.ogf == null ) {
this.started = true;
C$.ogf = Clazz.new_((I$[1]||(I$[1]=Clazz.load('com.falstad.WaveBoxFrame'))).c$$com_falstad_WaveBox,[this]);
C$.ogf.initFrame();
this.repaint();
}});
