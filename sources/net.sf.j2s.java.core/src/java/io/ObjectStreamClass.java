...
//    }
    ...
    private ObjectStreamClass(final Class<?> cl) {
        ...
        serializable = true;//Serializable.class.isAssignableFrom(cl);
    ...
    private static Long getDeclaredSUID(Class<?> cl) {
    	...
    	// SwingJS does not save final static values;
//        try {
...
//        return null;
    ...
    private static long computeDefaultSUID(Class<?> cl) {
        if (false && !Serializable.class.isAssignableFrom(cl) || Proxy.isProxyClass(cl))
        {
            return 0L;
        }
        return 1;
