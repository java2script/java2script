 ...
 * by a millisecond value within the day. There are three kinds of
 * <em>mode</em>s to specify the time: {@link #WALL_TIME},
 * {@link #STANDARD_TIME} and {@link #UTC_TIME}. For example, if daylight saving
 * time ends at 2:00 am in the wall clock time, it can be specified by 7200000
 * milliseconds in the {@link #WALL_TIME} mode. In this case, the wall clock
 * time for an <em>end-rule</em> means the same thing as the daylight time.
 * <p>
...
public class SimpleTimeZone extends TimeZone {
	...
	public int getOffsets(long date, int[] offsets) {
		...
		computeOffset: if (useDaylight) {
			...
			BaseCalendar cal = date >= GregorianCalendar.DEFAULT_GREGORIAN_CUTOVER ? getGcal()
	 ...
	 * @exception IllegalArgumentException
	 *                the <code>era</code>, <code>month</code>,
	 *                <code>day</code>, <code>dayOfWeek</code>, or
	...
	public boolean hasSameRules(TimeZone other) {
		...
		return rawOffset == that.rawOffset && useDaylight == that.useDaylight && (!useDaylight
				...
				|| (dstSavings == that.dstSavings && startMode == that.startMode && startMonth == that.startMonth
						&& startDay == that.startDay && startDayOfWeek == that.startDayOfWeek
						&& startTime == that.startTime && startTimeMode == that.startTimeMode && endMode == that.endMode
						&& endMonth == that.endMonth && endDay == that.endDay && endDayOfWeek == that.endDayOfWeek
						&& endTime == that.endTime && endTimeMode == that.endTimeMode && startYear == that.startYear));
	}
	...
	public String toString() {
		return getClass().getName() + "[id=" + getID() + ",offset=" + rawOffset + ",dstSavings=" + dstSavings
				...
				+ ",startTimeMode=" + startTimeMode + ",endMode=" + endMode + ",endMonth=" + endMonth + ",endDay="
				+ endDay + ",endDayOfWeek=" + endDayOfWeek + ",endTime=" + endTime + ",endTimeMode=" + endTimeMode
				+ ']';
	}
	 ...
	 * <dt><b>1</b></dt>
	 * <dd>JDK 1.1.4 or later. Includes three new fields:
	 * <code>startMode</code>, <code>endMode</code>, and
	 * <code>dstSavings</code>.</dd>
	 * <dt><b>2</b></dt>
	...
	// *
	// * @serialData We write out two formats, a JDK 1.1 compatible format,
	// using
	...
	// * emitted (int); this is 4 as of this release. The byte array of the
	// given
	// * length is emitted. The contents of the byte array are the true values
	// of
	// * the fields <code>startDay</code>, <code>startDayOfWeek</code>,
	// * <code>endDay</code>, and <code>endDayOfWeek</code>. The values of these
	// * fields in the required section are approximate values suited to the
	// rule
	// * mode <code>DOW_IN_MONTH_MODE</code>, which is the only mode recognized
	// by
	// * JDK 1.1.
	// */
	...
	// // startDayOfWeek and endDayOfWeek were usually uninitialized. We can't
	// do
