...
/**
 * SwingJS switching to unique string keys here for faster performance in JavaScript.
 * 
...
public class HashSet<E> extends AbstractSet<E> implements Set<E>, Cloneable, java.io.Serializable {
	...
	public boolean contains(Object o) {
		return map.containsKey(秘keyOf(o));
	}
	...
	public boolean add(E e) {
		return map.put(秘keyOf(e), e) == null;
	}
	...
	public boolean remove(Object o) {
		return map.remove(秘keyOf(o)) != null;
	}

	private String 秘keyOf(Object o) {
		return (o == null ? "null" : JSUtil.getJSID(o));
	}
...
//    }
	...
	public Spliterator<E> spliterator() {
		return new HashMap.ValueSpliterator<String, E>(map, 0, -1, 0, 0);
	}
}
