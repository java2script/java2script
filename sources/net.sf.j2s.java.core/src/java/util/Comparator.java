...
public interface Comparator<T> {
     ...
     * }</pre>
     *
     * @param  other_ the other comparator to be used when this comparator
     ...
     * @since 1.8
     */
    default Comparator<T> thenComparing(Comparator<? super T> other_) {
        Objects.requireNonNull(other_);
        return (Comparator<T> & Serializable) (c1, c2) -> {
            int res = compare(c1, c2);
            return (res != 0) ? res : other_.compare(c1, c2);
        };
    }
	...
	/**
	 * Accepts a function that extracts a {@link java.lang.Comparable Comparable}
	 * sort key from a type {@code T}, and returns a {@code
	 ...
	 * @param keyExtractor the function used to extract the {@link Comparable} sort
	 *                     key
	...
	public static <T, U extends Comparable<? super U>> Comparator<T> comparing(
		...
		return (Comparator<T>) new Comparator<T>() {
			...
			public int compare(Object c1, Object c2) {
				return keyExtractor.apply((T) c1).compareTo(keyExtractor.apply((T) c2));
			};
