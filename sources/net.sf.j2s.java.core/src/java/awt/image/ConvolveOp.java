...
// no support for IndexColorModel        // Can't convolve an IndexColorModel.  Need to expand it
...
//
        if (dst == null) {
            ...
            {
              throw new ImagingOpException ("SwingJS: Differing color spaces not allowed");
//                needToConvert = true;
//                dst = createCompatibleDestImage(src, null);
//                dstCM = dst.getColorModel();
            }
