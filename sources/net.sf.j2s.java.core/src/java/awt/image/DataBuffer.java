...
public abstract class DataBuffer {
	...
	public StateTrackableDelegate theTrackable; // SwingJS needs public here
	 ...
	 * @throws IllegalArgumentException if <code>type</code> is less than zero or
	 *                                  greater than {@link #TYPE_DOUBLE}
	 */
	public static int getDataTypeSize(int type) {
		if (type < TYPE_BYTE || type > TYPE_INT
// SwingJS not implemented        		|| type > TYPE_DOUBLE
		) {
	...
	/**
	 * Constructs a DataBuffer containing one bank of the specified data type and
	 * size with the indicated initial {@link State State}.
	 *
	...
	/**
	 * Constructs a DataBuffer containing the specified number of banks. Each bank
	 * has the specified size and an offset of 0.
	 *
	 * @param dataType the data type of this <code>DataBuffer</code>
	 * @param size     the size of the banks
	 ...
	 * indicated initial {@link State State}. Each bank has the specified size and
	 * an offset of 0.
	 *
	 * @param initialState the initial {@link State State} state of the data
	 * @param dataType     the data type of this <code>DataBuffer</code>
	...
	/**
	 * Constructs a DataBuffer that contains the specified number of banks with the
	 * indicated initial {@link State State}. Each bank has the specified datatype,
	 * size and offset.
	 *
	 * @param initialState the initial {@link State State} state of the data
	 * @param dataType     the data type of this <code>DataBuffer</code>
	...
	/**
	 * Constructs a DataBuffer which contains the specified number of banks. Each
	 * bank has the specified datatype and size. The offset for each bank is
	 * specified by its respective entry in the offsets array.
	 *
	 * @param dataType the data type of this <code>DataBuffer</code>
	 * @param size     the size of the banks
	 * @param numBanks the number of banks in this <code>DataBuffer</code>
	 * @param offsets  an array containing an offset for each bank.
	 * @throws ArrayIndexOutOfBoundsException if <code>numBanks</code> does not
	 *                                        equal the length of
	 *                                        <code>offsets</code>
	 */
	...
	/**
	 * Constructs a DataBuffer which contains the specified number of banks with the
	 * indicated initial {@link State State}. Each bank has the specified datatype
	 * and size. The offset for each bank is specified by its respective entry in
	 * the offsets array.
	 *
	 * @param initialState the initial {@link State State} state of the data
	 * @param dataType     the data type of this <code>DataBuffer</code>
	 ...
	 * @param i    the index of the requested data array element
	 * @return the data array element at the specified index from the specified bank
	 ...
	 * @param val the data to set the element at the specified index in the data
	 *            array
	 * @see #getElem(int)
	 * @see #getElem(int, int)
	 */
	 ...
	 * 
	 * @param i the index of the requested data array element
	 * @return a float value representing the data array element at the specified
	 *         index.
	 ...
	 * The implementation in this class is to cast {@link #getElem(int, int)} to a
	 * float. Subclasses can override this method if another implementation is
	 * needed.
	 * 
	 * @param bank the specified bank
	 * @param i    the index of the requested data array element
	 * @return a float value representing the data array element from the specified
	...
	/**
	 * Sets the requested data array element in the first (default) bank from the
	 * given float. The implementation in this class is to cast val to an int and
	 * call {@link #setElem(int, int)}. Subclasses can override this method if
	 * another implementation is needed.
	 * 
	 * @param i   the specified index
	 * @param val the value to set the element at the specified index in the data
	 *            array
	 ...
	 * {@link #setElem(int, int)}. Subclasses can override this method if another
	 * implementation is needed.
	 * 
	 * @param bank the specified bank
	 * @param i    the specified index
	 * @param val  the value to set the element in the specified bank at the
	 *             specified index in the data array
	 * @see #getElemFloat(int)
	 * @see #getElemFloat(int, int)
	 */
	...
	/**
	 * Returns the requested data array element from the first (default) bank as a
	 * double. The implementation in this class is to cast {@link #getElem(int)} to
	 * a double. Subclasses can override this method if another implementation is
	 * needed.
	 * 
	 * @param i the specified index
	 * @return a double value representing the element at the specified index in the
	 *         data array.
	 ...
	 * @param bank the specified bank
	 * @param i    the specified index
	 * @return a double value representing the element from the specified bank at
