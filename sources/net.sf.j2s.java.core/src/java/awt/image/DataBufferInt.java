...
public final class DataBufferInt extends DataBuffer {
	...
	/**
	 * Constructs an integer-based <CODE>DataBuffer</CODE> with a single bank and
	 * the specified size.
	 * 
	 * @param size
	 ...
	 * using the specified array. Only the first <CODE>size</CODE> elements should
	 ...
	 * used by some implementations (such as caching an associated image in video
	 * memory).
	 * 
	 * @param dataArray
	...
	/**
	 * Constructs an integer-based <CODE>DataBuffer</CODE> with the specified
	 * arrays. The number of banks will be equal to <CODE>dataArray.length</CODE>.
	 ...
	 * <CODE>size</CODE> + the corresponding offset. There must be an entry in the
	 * offset array for each <CODE>dataArray</CODE> entry. For each bank, only
	 * elements <CODE>offset</CODE> through <CODE>offset</CODE> +
	 * <CODE>size</CODE> - 1 should be used by accessors of this
	 * <CODE>DataBuffer</CODE>.
	 * <p>
	 ...
	 * be incompatible with <a href="#optimizations">performance optimizations</a>
	 * used by some implementations (such as caching an associated image in video
	 * memory).
	 * 
