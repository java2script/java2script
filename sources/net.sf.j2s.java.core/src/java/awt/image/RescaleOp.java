...
public class RescaleOp implements BufferedImageOp, RasterOp {
    public float[] scaleFactors; // SwingJS needed public here
    public float[] offsets;      // SwingJS needed public here
    int length = 0;
    RenderingHints hints;
    public int swingJStype = 'R';
...
//                dst = createCompatibleDestImage(src, null);
        ...
        //
// SwingJS no native ops        if (ImagingLib.filter(this, src, dst) == null) {
            //
...
//        }
        ...
        if (canUseLookup(src, dst)) {
            ...
            if (dstNgray != 256) {
            	throw new ImagingOpException("SwingJS requires 256 gray scale"); 
            }
            if (dstNgray == 256) {
