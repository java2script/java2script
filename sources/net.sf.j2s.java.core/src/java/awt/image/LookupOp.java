...
//        numComponents = ltable.getNumComponents();
    ...
    @Override
        ...
        ColorModel dstCM;
// SwingJS not supported        if (srcCM instanceof IndexColorModel) {
//            throw new
...
//        boolean needToConvert = false;
        ...
        if (dst == null) {
            ...
            {
            	throw new ImagingOpException ("SwingJS: Only RGB color space is supported");
//            	  needToConvert = true;
//                dst = createCompatibleDestImage(src, null);
            }
