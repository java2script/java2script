...
public class ColorConvertOp implements BufferedImageOp, RasterOp {
    ...
    private final BufferedImage nonICCBIFilter(BufferedImage src,
    		...
    		JSUtil.notImplemented("ColorConvertOp does not implement ColorConvertOp.nonICCBIFilter");
    		return null;
//
//        int w = src.getWidth();
//        int h = src.getHeight();
...
//        return dst;
    ...
    private final WritableRaster nonICCRasterFilter(Raster src,
		...
		JSUtil.notImplemented("ColorConvertOp does not implement ColorConvertOp.nonICCRRasterFilter");
		return null;
