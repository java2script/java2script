...
//	private static final long serialVersionUID = 8367026044764648243L;
	 ...
	 * characteristics:
	 * <p>
	 * If the <code>mimeType</code> is "application/x-java-serialized-object;
	 * class=&lt;representation class&gt;", the result is the same as calling
	 ...
	 * equal. Additionally, if the primary type is "text", the subtype denotes a
	 * text flavor which supports the charset parameter, and the representation
	 * class is not <code>java.io.Reader</code>, <code>java.lang.String</code>,
	 ...
	 * considered in the comparison. If <code>representationClass</code> needs
	 * to be compared, then <code>equals(new DataFlavor(s))</code> may be used.
	 *
	...
	public boolean isFlavorSerializedObjectType() {
		return false;// isRepresentationClassSerializable() &&
