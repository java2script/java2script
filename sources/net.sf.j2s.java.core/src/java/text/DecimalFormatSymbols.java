...
public class DecimalFormatSymbols implements Cloneable {
	...
	/**
	 * Create a DecimalFormatSymbols object for the default locale. This constructor
	 ...
	 * DecimalFormatSymbolsProvider} implementations. For full locale coverage, use
...
//
	...
	public boolean equals(Object obj) {
		...
		return (zeroDigit == other.zeroDigit && groupingSeparator == other.groupingSeparator
				...
				&& currencySymbol.equals(other.currencySymbol) && intlCurrencySymbol.equals(other.intlCurrencySymbol) &&
...
//    }
	 ...
	 * <p>
	 * Note that the public API provides no way to set this field, even though it is
	 * supported by the implementation and the stream format. The intent is that
	...
	/**
	 * The string used to separate the mantissa from the exponent. Examples: "x10^"
	 * for 1.23x10^4, "E" for 1.23E4.
	 * <p>
	 * If both <code>exponential</code> and <code>exponentialSeparator</code> exist,
	 * this <code>exponentialSeparator</code> has the precedence.
	 *
	 * @serial
	 * @since 1.6
	 */
