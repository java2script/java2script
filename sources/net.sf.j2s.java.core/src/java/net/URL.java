...
//
	 ...
	 * the remote object referred to by the <code>URL</code>.
	 * 
	 * <p>
	 * A new connection is opened every time by calling the
	 * <code>openConnection</code> method of the protocol handler for this URL.
	 * 
	 * <p>
	 ...
	 *              if an I/O exception occurs. see
	 *              java.net.URL#URL(java.lang.String, java.lang.String, int,
	 *              java.lang.String)
	...
	/*
    *//**
	 * Same as openConnection(), except that the connection will be made
	 * through the specified proxy; Protocol handlers that do not support proxing
	 ...
	 * 
	 * @param proxy
	 *          the Proxy through which this connection will be made. If direct
	 *          connection is desired, Proxy.NO_PROXY should be specified.
	 * @return a <code>URLConnection</code> to the URL.
	 * @exception IOException
	 *              if an I/O exception occurs.
	 * @exception SecurityException
	 *              if a security manager is present and the caller doesn't have
	 *              permission to connect to the proxy.
	 * @exception IllegalArgumentException
	 *              will be thrown if proxy is null, or proxy has the wrong type
	 * @exception UnsupportedOperationException
	 *              if the subclass that implements the protocol handler doesn't
	 *              support this method.
	 * @see java.net.URL#URL(java.lang.String, java.lang.String, int,
	 *      java.lang.String)
	 * @see java.net.URLConnection
	 ...
	 */
	/*
	 * public URLConnection openConnection(Proxy proxy) throws IOException { if
	 * (proxy == null) { throw new
	 * IllegalArgumentException("proxy can not be null"); }
	 * 
	 * SecurityManager sm = System.getSecurityManager(); if (proxy.type() !=
	 * Proxy.Type.DIRECT && sm != null) { InetSocketAddress epoint =
	 * (InetSocketAddress) proxy.address(); if (epoint.isUnresolved())
	 ...
	 * <code>InputStream</code> for reading from that connection. This method is a
	 ...
	 * be called at most once in a given Java Virtual Machine.
	 * 
	 * <p>
	 * The <code>URLStreamHandlerFactory</code> instance is used to construct a
	 ...
	 *              operation. see java.net.URL#URL(java.lang.String,
	 *              java.lang.String, int, java.lang.String)
