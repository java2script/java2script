...
#if[byte]
 *
 * content, or by {@link #wrap(short[]) <i>wrapping</i>} an
 * existing short array {#if[char]?or&#32;string} into a buffer.
 *
#else[byte]
 *
...
public abstract class ShortBuffer
     ...
     */
    public abstract ShortBuffer put(short $x$);
     ...
     *          If this buffer is read-only
     */
    public abstract ShortBuffer put(int index, short $x$);
     ...
     *   This method considers two short elements {@code a} and {@code b}
     *   to be equal if
     ...
     * {@link $Fulltype$#compare(short,short)}, except that
     * {@code -0.0} and {@code 0.0} are considered to be equal.
     * {@code $Fulltype$.NaN} is considered by this method to be equal
     * to itself and greater than all other {@code short} values
     * (including {@code $Fulltype$.POSITIVE_INFINITY}).
#else[floatingPointType]
     * Pairs of {@code short} elements are compared as if by invoking
     * {@link $Fulltype$#compare(short,short)}.
#end[floatingPointType]
     *
