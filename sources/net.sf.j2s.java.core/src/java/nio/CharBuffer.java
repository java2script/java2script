...
#if[byte]
 *
 * content, or by {@link #wrap(char[]) <i>wrapping</i>} an
 * existing char array {#if[char]?or&#32;string} into a buffer.
 *
#else[byte]
 *
    ...
    implements Comparable<CharBuffer>, Appendable, CharSequence, Readable
{
     ...
     */
    public abstract CharBuffer put(char $x$);
     ...
     *          If this buffer is read-only
     */
    public abstract CharBuffer put(int index, char $x$);
     ...
     *   This method considers two char elements {@code a} and {@code b}
     *   to be equal if
     *   {@code (a == b) || (Character.isNaN(a) && Character.isNaN(b))}.
     *   The values {@code -0.0} and {@code +0.0} are considered to be
     *   equal, unlike {@link Character#equals(Object)}.
     ...
     * {@link Character#compare(char,char)}, except that
     * {@code -0.0} and {@code 0.0} are considered to be equal.
     * {@code Character.NaN} is considered by this method to be equal
     * to itself and greater than all other {@code char} values
     * (including {@code Character.POSITIVE_INFINITY}).
     ...
     * @since  1.5
     */
    public CharBuffer append(char $x$) {
        return put($x$);
    }
