  ...
  extends DoubleBuffer
{
  ...
  public DoubleBuffer slice()
  {
    ...
    assert (m >= 0);
    return new ByteBufferAsDoubleBufferL(this.bb, -1, 0, k, k, m);
  }
  
  public DoubleBuffer duplicate()
  {
    return new ByteBufferAsDoubleBufferL(this.bb, 
      markValue(), 
      position(), 
      limit(), 
  ...
  public double get()
  {
    return Bits.getDoubleL(this.bb, ix(nextGetIndex()));
  }
  
  public double get(int paramInt)
  {
    return Bits.getDoubleL(this.bb, ix(checkIndex(paramInt)));
  }
  
  public DoubleBuffer put(double paramDouble)
  {
    Bits.putDoubleL(this.bb, ix(nextPutIndex()), paramDouble);
    return this;
  }
  
  public DoubleBuffer put(int paramInt, double paramDouble)
  {
    Bits.putDoubleL(this.bb, ix(checkIndex(paramInt)), paramDouble);
    return this;
  }
