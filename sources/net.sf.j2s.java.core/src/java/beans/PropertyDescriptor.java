...
// SwingJS not implementing java.beans.Introspector for now
...
public class PropertyDescriptor extends FeatureDescriptor {
    ...
    private Method /*Reference<Method>*/ readMethodRef;
    private Method /*Reference<Method>*/ writeMethodRef;
    private Class /*Reference<Class>*/ propertyEditorClassRef;
...
//        setName(Introspector.decapitalize(base));
    ...
    private void setPropertyType(Class type) {
        this.propertyTypeRef = type;//getWeakReference(type);
    }
...
//            }
    ...
    public synchronized void setReadMethod(Method readMethod)
        ...
        this.readMethodRef = readMethod;//getSoftReference(readMethod);
    }
...
//                          (type == null) ? null : new Class[] { type });
    ...
    public synchronized void setWriteMethod(Method writeMethod)
        ...
        this.writeMethodRef = writeMethod;//getSoftReference(writeMethod);
