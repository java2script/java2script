...
//SwingJS fix for Java - this would only allow one running application or applet to do this
    ...
    private static Object lock = null;//new Lock();
    ...
    static void add(int slot, boolean registerShutdownInProgress, Runnable hook) {
        synchronized (lock) {
        	Runnable[] hooks = getHooks(true); // SwingJS
            if (hooks[slot] != null)
    ...
    private static Runnable[] getHooks(boolean andCreate) {
    	if (groupHooks == null) {
    		if (!andCreate)
    			return null;
