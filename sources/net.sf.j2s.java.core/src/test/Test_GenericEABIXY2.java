...
/**
 * This is the troubling class. We have a method that appears not to have a generic-replaced method,
 * because its class def has no indication of it. But actually it does, and we have to alias it in this
 * class to all its precursor qualified names.
 *  
 * @author RM
 *
 */
class Test_GenericEABIXY2 extends Test_GenericEABIXY {
	...
	/**
	 * note that this has to be the EXACT signature as listed above, and it has to match.
	 * 
	 */
