package test.baeldung.doublecolon;
...
public class Computer {
    ...
    public void turnOnPc() {
        System.out.println("Computer turned on " + this);
    }

    public static void turnOffPcStatic(Computer c) {
    	c.turnOffPc();
   }

    public void turnOffPc() {
        System.out.println("Computer turned off " + this);
    }
