 ...
 * computed values of an element. See also the <code>ViewCSS</code> interface.
...
public interface CSSStyleDeclaration {
     ...
     * the parsing of the new value and resetting of the properties in the 
     * declaration block. It also allows the insertion of additional 
     * properties and their values into the block. 
