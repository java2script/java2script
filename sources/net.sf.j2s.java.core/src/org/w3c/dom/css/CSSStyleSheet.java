...
public interface CSSStyleSheet extends StyleSheet {
     ...
     *   readonly.
     *   <br> SYNTAX_ERR: Raised if the specified rule has a syntax error  
     *   and is unparsable.
     */
     ...
     *   to remove. 
     * @exception DOMException
     *    INDEX_SIZE_ERR: Raised if the specified index does not correspond 
     *   to a rule in the style sheet's rule list.
     *   <br> NO_MODIFICATION_ALLOWED_ERR: Raised if this style sheet is 
     *   readonly.
     */
