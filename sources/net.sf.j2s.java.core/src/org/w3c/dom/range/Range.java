...
public interface Range {
     ...
     * start of the Range. Adjacent Text nodes will not be automatically 
     * merged.
     ...
     * @return  The contents of the Range. Only the data characters.
     * @exception DOMException
     *    INVALID_STATE_ERR: Raised if <code>detach()</code> has already been 
     *   invoked on this object.
     */
     ...
     * will result in a <code>DOMException</code> being thrown with an error 
     * code of<code>INVALID_STATE_ERR</code> .
     * @exception DOMException
     *    INVALID_STATE_ERR: Raised if <code>detach()</code> has already been 
     *   invoked on this object.
     */
