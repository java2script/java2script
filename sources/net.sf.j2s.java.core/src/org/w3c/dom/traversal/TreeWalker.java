 ...
 * <code>NodeFilter</code> that skips all nodes except for Text nodes and the 
...
public interface TreeWalker {
     ...
     * they  and their descendents will be rejected. Note that this rejection 
     ...
     * longer be accepted by the <code>TreeWalker</code> 's associated filter.
