...
public interface DocumentTraversal {
     ...
     *   node. The <code>whatToShow</code> flags and the filter, if any, are 
     *   not considered when setting this position. The root must not be 
     *   <code>null</code> .
     ...
     *   <code>parentNode</code> and nextNode. The <code>root</code> must not 
     *   be<code>null</code> .
     * @param whatToShow  This flag specifies which node types may appear in 
     *   the logical view of the tree presented by the tree-walker. See the 
     *   description of<code>NodeFilter</code> for the set of possible SHOW_ 
