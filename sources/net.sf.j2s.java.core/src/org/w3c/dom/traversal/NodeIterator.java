 ...
 * nodes. The set of nodes to be iterated is determined by the implementation 
 * of the <code>NodeIterator</code> . DOM Level 2 specifies a single
...
public interface NodeIterator {
     ...
     * descendents will be rejected. Note that this rejection takes 
     * precedence over <code>whatToShow</code> and the filter. Also note that 
     * this is currently the only situation where <code>NodeIterators</code> 
