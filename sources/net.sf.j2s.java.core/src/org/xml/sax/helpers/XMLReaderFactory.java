...
final public class XMLReaderFactory {
	 ...
	 * can support it, the name of the XMLReader class is determined by trying each
	 * these options in order, and using the first one which succeeds:
	 * </p>
	 * <ul>
	 *
	 * <li>If the system property <code>org.xml.sax.driver</code> has a value, that
	 * is used as an XMLReader class name.</li>
	 *
	 ...
	 * default SAX1 parser, that parser is wrapped in a {@link ParserAdapter}. (This
	 * is a migration aid for SAX1 environments, where the
	 * <code>org.xml.sax.parser</code> system property will often be usable.)</li>
	 *
	 * </ul>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * Note that many Java environments allow system properties to be initialized on
	 * a command line. This means that <em>in most cases</em> setting a good value
	 * for that property ensures that calls to this method will succeed, except when
	 * security policies intervene. This will also maximize application portability
	 * to older SAX environments, with less robust implementations of this method.
	 * </p>
	 *
	 * @return A new XMLReader.
	 * @exception org.xml.sax.SAXException If no default XMLReader class can be
...
// END DISTRIBUTION-SPECIFIC
	 ...
	 * @exception org.xml.sax.SAXException If the class cannot be loaded,
