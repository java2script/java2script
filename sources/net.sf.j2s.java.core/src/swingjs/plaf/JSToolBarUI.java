...
public class JSToolBarUI extends JSPanelUI {
	...
	protected void installKeyboardActions() {
		...
		LazyActionMap.installLazyActionMap(toolBar, JSToolBarUI.class, "ToolBar.actionMap");
	}
	...
	/**
	 * Creates a rollover border for toolbar components. The rollover border will be
	 * installed if rollover borders are enabled.
	 * <p>
	...
	/**
	 * Creates the non rollover border for toolbar components. This border will be
	 * installed as the border for components added to the toolbar if rollover
	 * borders are not enabled.
	 * <p>
	 * Override this method to provide an alternate rollover border.
	 *
	 * @since 1.4
	...
	private Border createNonRolloverToggleBorder() {
		...
		return new CompoundBorder(new BasicBorders.RadioButtonBorder(table.getColor("ToggleButton.shadow"),
				...
				table.getColor("ToggleButton.highlight")), new BasicBorders.RolloverMarginBorder());
	}
...
//
	...
	/**
	 * Sets the flag for enabling rollover borders on the toolbar and it will also
	 * install the apropriate border depending on the state of the flag.
	 *
	 * @param rollover if true, rollover borders are installed. Otherwise
...
//				setBorderToRollover(components[i]);
	 ...
	 * <p>
	 * This is a convenience method to call <code>setBorderToNonRollover</code> for
	 * each child component.
	 *
	 * @param c container which holds the child components (usally a JToolBar)
	 ...
	 * <p>
	 * This is a convenience method to call <code>setBorderNormal</code> for each
	 * child component.
	 *
	 * @param c container which holds the child components (usally a JToolBar)
	 * @see #setBorderToNonRollover
	...
	/**
	 * Sets the border of the component to have a rollover border which was created
	 * by <code>createRolloverBorder</code>.
	 *
	...
	/**
	 * Sets the border of the component to have a normal border. A normal border is
	 * the original border that was installed on the child component before it was
	...
	private static class Actions extends UIAction {
		...
		public void actionPerformed(ActionEvent evt) {
			...
			JSToolBarUI ui = (JSToolBarUI) toolBar.getUI();
	...
	protected class DragWindow extends Window {
		 ...
		 * The orientation is either one of <code>JToolBar.HORIZONTAL</code> or
