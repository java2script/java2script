...
public class PDFJob extends PrintJob implements Serializable
{
  ...
  public Graphics getGraphics(int orient) {
    ...
    return new PDFGraphic(page,this);
  }
   ...
   */
  class PDFGraphic extends PDFGraphics implements PrintGraphics {
    /**
     ...
     */
    PDFGraphic(PDFPage page,PDFJob job) {
      super();
      this.init(page);
      this.job = job;
    }
     ...
     */
    PDFGraphic(PDFPage page,PDFJob job,PrintWriter pw) {
      super();
      this.init(page,pw);
      this.job = job;
    }
    ...
    @Override
      ...
      closeBlock();
      PDFGraphic g = new PDFGraphic(getPage(),job,getWriter());
    ...
    /**
     * This is the PrintGics interface
