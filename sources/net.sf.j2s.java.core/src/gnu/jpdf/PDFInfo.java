...
public class PDFInfo extends PDFObject
{
  ...
  public void write(OutputStream os) throws IOException {
    ...
    if(author!=null) {
      PDFStream.write(os, "/Author (");
      PDFStream.write(os, PDFStringHelper.makePDFString(author));
      PDFStream.write(os, ")\n");
    }
    
    if(creator!=null) {
      PDFStream.write(os, "/Creator (");
      PDFStream.write(os, PDFStringHelper.makePDFString(creator));
      PDFStream.write(os, ")\n");
    }
    
    PDFStream.write(os, "/Producer ");
    PDFStream.write(os, PDFStringHelper.makePDFString("gnujpdf - gnujpdf.sourceforge.net")
             );
    PDFStream.write(os, "\n");
    ...
    if(subject!=null) {
      PDFStream.write(os, "/Subject (");
      PDFStream.write(os, PDFStringHelper.makePDFString(subject));
      PDFStream.write(os, ")\n");
    }
    
    if(keywords!=null) {
      PDFStream.write(os, "/Keywords (");
      PDFStream.write(os, PDFStringHelper.makePDFString(keywords));
      PDFStream.write(os, ")\n");
    }
