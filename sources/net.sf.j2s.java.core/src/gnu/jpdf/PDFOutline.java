...
public class PDFOutline extends PDFObject implements Serializable
{
   ...
   */
    ...
    public void write(OutputStream os) throws IOException
    {
        ...
        if(parent!=null) {
            PDFStream.write(os, "/Title ");
            PDFStream.write(os, PDFStringHelper.makePDFString(title));
            PDFStream.write(os, "\n/Dest [");
            PDFStream.write(os, dest.toString());
            
            if(destMode==FITPAGE) {
                //PDFStream.write(os, " null null null]\n/Parent ");
                PDFStream.write(os, " /Fit]\n/Parent ");
            } else {
                PDFStream.write(os, " /FitR ");
                PDFStream.write(os, Integer.toString(l));
                PDFStream.write(os, " ");
                PDFStream.write(os, Integer.toString(b));
                PDFStream.write(os, " ");
                PDFStream.write(os, Integer.toString(r));
                PDFStream.write(os, " ");
                PDFStream.write(os, Integer.toString(t));
                PDFStream.write(os, "]\n/Parent ");
            }
            PDFStream.write(os, parent.toString());
            PDFStream.write(os, "\n");
        }
        ...
        if(parent==null) {
            ...
            PDFStream.write(os, "/Count ");
            PDFStream.write(os, Integer.toString(outlines.size()));
            PDFStream.write(os, "\n");
        } else {
            ...
            if(c>0) {
                PDFStream.write(os, "/Count ");
                PDFStream.write(os, Integer.toString(-c));
                PDFStream.write(os, "\n");
            }
        }
        ...
        if(outlines.size()>0) {
            ...
            PDFStream.write(os, "/First ");
            PDFStream.write(os, outlines.elementAt(0).toString());
            PDFStream.write(os, "\n");
            
            // the number of the last outline in list
            PDFStream.write(os, "/Last ");
            PDFStream.write(os, outlines.elementAt(outlines.size()-1).toString());
            PDFStream.write(os, "\n");
        }
        ...
        if(parent!=null) {
            ...
            if(index>0) {
                ...
                PDFStream.write(os, "/Prev ");
                PDFStream.write(os, parent.getNode(index-1).toString());
                PDFStream.write(os, "\n");
            }
            if(index<parent.getLast()) {
                // We have a /Next node
                PDFStream.write(os, "/Next ");
                PDFStream.write(os, parent.getNode(index+1).toString());
                PDFStream.write(os, "\n");
            }
        }
