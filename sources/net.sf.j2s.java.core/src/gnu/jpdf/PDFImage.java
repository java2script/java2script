...
public class PDFImage extends PDFStream implements ImageObserver, Serializable
{
  ...
  public void writeStream(OutputStream os) throws IOException {
    ...
    /*
    PDFStream.write(os, "/Length ");
    // Accout for stream\n ... >\nendstream
    PDFStream.write(os, Integer.toString(buf.size() + 18));
    ...
    */
    ...
    //PDFStream.write(os, "/Filter [/FlateDecode /ASCIIHexDecode]\n");
    PDFStream.write(os, "/Filter [/FlateDecode /ASCII85Decode]\n");
    PDFStream.write(os, "/Length ");
    PDFStream.write(os, Integer.toString(b.size()));
    PDFStream.write(os, "\n>>\nstream\n");
    b.writeTo(os);
    PDFStream.write(os, "\nendstream\nendobj\n");
  ...
  public void write(OutputStream os) throws IOException
  {
    ...
    PDFStream.write(os, "/Subtype /Image\n/Name ");
    PDFStream.write(os, name);
    PDFStream.write(os, "\n/Width ");
    PDFStream.write(os, Integer.toString(width));
    PDFStream.write(os, "\n/Height ");
    PDFStream.write(os, Integer.toString(height));
