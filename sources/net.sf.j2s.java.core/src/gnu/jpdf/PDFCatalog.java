...
public class PDFCatalog extends PDFObject
{
  ...
  public void write(OutputStream os) throws IOException {
    ...
    if(outlines!=null) {
      ...
      PDFStream.write(os, "/Outlines ");
      PDFStream.write(os, outlines.toString());
      PDFStream.write(os, "\n");
      //}
    }
            
    // the /PageMode setting
    PDFStream.write(os, "/PageMode ");
    PDFStream.write(os, PDFDocument.PDF_PAGE_MODES[pagemode]);
    PDFStream.write(os, "\n");
