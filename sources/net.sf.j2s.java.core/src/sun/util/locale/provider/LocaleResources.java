...
//        
    ...
    int getCalendarData(String key) {
        ...
        caldata = (Integer) cache.get(cacheKey);
        if ((caldata == null)) {
    ...
    public String getCollationData() {
        ...
        coldata = (String) cache.get(COLLATION_DATA_CACHEKEY);
        if (coldata == null) {
            ResourceBundle rb = localeData.getCollationData(locale);
            if (rb.containsKey(key)) {
                coldata = rb.getString(key);
            }
            cache.put(COLLATION_DATA_CACHEKEY, (Object) coldata);
        }
    ...
    public Object[] getDecimalFormatSymbolsData() {
        ...
        dfsdata = (Object[]) cache.get(DECIMAL_FORMAT_SYMBOLS_DATA_CACHEKEY);
        if (dfsdata  == null) {
            ...
            cache.put(DECIMAL_FORMAT_SYMBOLS_DATA_CACHEKEY, (Object) dfsdata);
        }
    ...
    public String getCurrencyName(String key) {
        ...
        currencyName = cache.get(cacheKey);
    ...
    String[] getTimeZoneNames(String key, int size) {
        ...
        names = (String[]) cache.get(cacheKey);

        if (names == null) {
            TimeZoneNamesBundle tznb = localeData.getTimeZoneNames(locale);
            if (tznb.containsKey(key)) {
                names = tznb.getStringArray(key, size);
                cache.put(cacheKey, (Object) names);
            }
        }
    ...
    Set<String> getZoneIDs() {
        ...
        zoneIDs = (Set<String>) cache.get(ZONE_IDS_CACHEKEY);
        if (zoneIDs == null) {
            TimeZoneNamesBundle rb = localeData.getTimeZoneNames(locale);
            zoneIDs = rb.keySet();
            cache.put(ZONE_IDS_CACHEKEY, (Object) zoneIDs);
        }
    ...
    public String getDateTimePattern(int timeStyle, int dateStyle, Calendar cal) {
        ...
        return getDateTimePattern(null, timeStyle, dateStyle, "gregory");
        //cal.getcal.getCalendarType()
        //);
    }
    ...
    public String[] getNumberPatterns() {
        ...
        numberPatterns = (String[]) cache.get(NUMBER_PATTERNS_CACHEKEY);

        if (numberPatterns == null) {
            ResourceBundle resource = localeData.getNumberFormatData(locale);
            numberPatterns = resource.getStringArray("NumberPatterns");
            cache.put(NUMBER_PATTERNS_CACHEKEY, (Object) numberPatterns);
        }
