...
//
        ...
        // SwingJS coercing standard Font here.
        Font2D font2D = (Font2D)(Object) font;//FontUtilities.getFont2D(font);
...
//            }
    ...
    public static final class GVData {
        ...
        public StandardGlyphVector createGlyphVector(Font font, FontRenderContext frc, StandardGlyphVector result) {
        	...
        	// SwingJS note: _count, _indices, and _positions are from C++ layout engine
...
//                }
// SwingJS not supporting special no-breaking marks
...
//            }
        ...
        void layout() {
            ...
            // SwingJS bypasses this C++ routine to set _count, _positions, and _glyphs 
