...
public class IntegerInterleavedRaster extends IntegerComponentRaster {
	 ...
	 * DataBuffer. The Raster's upper left corner is origin and it is the same sizes
	 * the SampleModel. The DataBuffer is not initialized and must be a
	...
	/**
	 * Constructs a IntegerInterleavedRaster with the given SampleModel, DataBuffer,
	 ...
	 * the coodinate in the new Raster's coordinate system of the origin of the base
	...
	/**
	 * Returns data offset for the specified band. The data offset is the index into
	 * the data array in which the first sample of the first scanline is stored.
	 */
	@Override
	 ...
	 * inputRaster must match this raster. An ArrayIndexOutOfBoundsException will be
	 ...
	 * this raster to the upper-left corner of the subraster. A subset of the bands
	 * of the parent raster may be specified. If this is null, then all the bands
	 * are present in the subRaster. Note that the subraster will reference the same
	...
	/**
	 * Creates a raster with the same data layout and the same width and height, and
