...
final public class AU {
	...
	/**
	 * Very important that this not be used with Int32Array or Float32Array, because
	 * it is not initialize to all zeros in MSIE 9.
	 * 
	 * @param array
	 * @param minimumLength
	 * @return array
	...
	public static Object ensureLength(Object array, int minimumLength) {
		return (array != null && getLength(array) >= minimumLength ? array : arrayCopyObject(array, minimumLength));
	}
	...
	/**
	 * Very important that this not be used with Int32Array or Float32Array, because
	 * it is not initialized to all zeros in MSIE 9.
	 * 
	 * @param array
	 * @return array
	 */
	...
	/**
	 * Very important that this not be used with Int32Array or Float32Array, because
	 * those need to be initialized to all zeros in MSIE 9, and MSIE 9 cannot
	 * distinguish Int32Array or Float32Array from Array.
	 * 
	 * @param array
	 * @param n
	 * @return array
	...
	/**
	 * a specialized method that allows copying from a starting point either to the
	 * end or to the middle (color schemes, especially)
	 * 
	 * @param array
	 * @param i0
	 * @param n
	...
	/**
	 * Ensure that we have signed and not unsigned bytes coming out of any process,
	 * but particularly out of file reading.
	 * 
	 * @param b
	 * @return b
	 */
	public static byte[] ensureSignedBytes(byte[] b) {
		if (b != null) {
			 ...
			 * @j2sNative
			 * 
			 * 			for (var i = b.length; --i >= 0;) { var j = b[i] & 0xFF; if (j >=
			 *            0x80) j -= 0x100; b[i] = j; }
			 * 
			 */
			{
   ...
   * @return new float[]
	...
	/**
	 * Correctly converts floats to double.
	 * No copy in JavaScript; copy in Java.
	 * 
	 * @param a
   * @return double[]
