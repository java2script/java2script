...
/**
 * A generic 4 element tuple that is represented by single precision doubleing
...
public abstract class T4d extends T3d {
   ...
   *        the w coordinate
   */
  public final void set4(double x, double y, double z, double w) {
    this.x = x;
    this.y = y;
    this.z = z;
    this.w = w;
   ...
   *        the scalar value
   */
  public final void scale4(double s) {
    scale(s);
    w *= s;
  }
