...
/**
 * A single precision doubleing point 3 by 3 matrix.
 * 
...
public class M3d extends M34d implements Serializable {
   ...
   * @return m
   */
  public static M3d newA9(double[] v) {
    M3d m = new M3d();
    m.setA(v);
    return m;
  }
   ...
   */
  public void setColumn3(int column, double x, double y, double z) {
    switch (column) {
    case 0:
      m00 = x;
      m10 = y;
   ...
   * @return this
   */
  public M3d setAsXRotation(double angle) {
    setXRot(angle);
    return this;
  }
   ...
   * @return this
   */
  public M3d setAsYRotation(double angle) {
    setYRot(angle);
    return this;
  }
   ...
   * @return this
   */
  public M3d setAsZRotation(double angle) {
    setZRot(angle);
    return this;
  }
  ...
  public int hashCode() {
    return T3d.doubleToIntBits(m00) ^ T3d.doubleToIntBits(m01)
        ^ T3d.doubleToIntBits(m02) ^ T3d.doubleToIntBits(m10)
        ^ T3d.doubleToIntBits(m11) ^ T3d.doubleToIntBits(m12)
        ^ T3d.doubleToIntBits(m20) ^ T3d.doubleToIntBits(m21)
        ^ T3d.doubleToIntBits(m22);
  }
   ...
   * @param m22
   */
  private void set9(double m00, double m01, double m02, double m10, double m11,
   ...
   */
  public boolean setAsBallRotation(double responseFactor, double dx, double dy) {
    double r = Math.sqrt(dx * dx + dy * dy);
    double th =  r * responseFactor;
    if (th == 0) {
      setScale(1);
      return false;
    }
