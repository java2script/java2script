...
/**
  ...
  *
  * <p>Usage: java -Djavax.xml.sax.parser=<var>classname</var> EntityDemo
  * <var>systemId</var></p>
  *
...
public class EntityDemo extends DemoHandler {
    ...
    throws Exception
  {
    ...
    if (args.length != 1) {
      System.err.println("Usage: java -Djavax.xml.sax.parser=<classname> " +
			 "EntityDemo <document>");
      System.exit(2);
    }

				// Make the parser, using the value
				// provided in the javax.xml.sax.parser property.
