...
public class JFileChooser extends JComponent {
    ...
    private ArrayList<FileFilter> filters = new ArrayList<FileFilter>(5);
...
//        this((File) null, (FileSystemView) null);
    ...
    public JFileChooser(String currentDirectoryPath) {
        this(new File(currentDirectoryPath));//, (FileSystemView) null);
    }
...
//        currentDirectory = dir;
    ...
    public void changeToParentDirectory() {
        ...
        setCurrentDirectory(getParentDirectory(oldValue));
    }

    private File getParentDirectory(File f) {
...
//        return returnValue;
    ...
    protected JDialog createDialog(Component parent)  {
    	String title = this.dialogTitle;//getUI().getDialogTitle(this);
    	if (title == null)
    		title = "SwingJS";
...
//                          title);
    ...
    public void resetChoosableFileFilters() {
        FileFilter[] oldValue = getChoosableFileFilters();
        setFileFilter(null);
        filters.clear();//removeAllElements();
        if(isAcceptAllFileFilterUsed()) {
    ...
    public FileFilter getAcceptAllFileFilter() {
        return new FileFilter(new String[] {"*.*", "All Files"});
    }
...
//        setUI(ui);
//
//        uiFileView = new FileView();//getUI().getFileView(this);
//        if(isAcceptAllFileFilterUsed()) {
//            addChoosableFileFilter(getAcceptAllFileFilter());
//        }
//    }
