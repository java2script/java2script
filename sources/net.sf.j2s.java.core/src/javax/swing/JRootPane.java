 ...
 * panes.
 * <p align=center>
 * <img src="doc-files/JRootPane-1.gif"
 * alt="The following text describes this graphic." HEIGHT=484 WIDTH=629>
 * </p>
 ...
 * alt="The following text describes this graphic." HEIGHT=386 WIDTH=349></td>
 * </tr>
 * </table>
...
public class JRootPane extends JComponent {
	...
	/**
	 * Constant used for the windowDecorationStyle property. Indicates that the
	 * <code>JRootPane</code> should provide decorations appropriate for a Frame.
	 * 
	 * @since 1.4
	 */
	...
	/**
	 * Constant used for the windowDecorationStyle property. Indicates that the
	 * <code>JRootPane</code> should provide decorations appropriate for a Dialog.
	 * 
	 * @since 1.4
	 */
	 ...
	 * Constant used for the windowDecorationStyle property. Indicates that the
	 * <code>JRootPane</code> should provide decorations appropriate for a Dialog
	 * used to display a <code>JColorChooser</code>.
	 * 
	 * @since 1.4
	 */
	 ...
	 * Constant used for the windowDecorationStyle property. Indicates that the
	 * <code>JRootPane</code> should provide decorations appropriate for a Dialog
	 * used to display a <code>JFileChooser</code>.
	 * 
	 * @since 1.4
	 */
	 ...
	 * Constant used for the windowDecorationStyle property. Indicates that the
	 * <code>JRootPane</code> should provide decorations appropriate for a Dialog
	 * used to present a question to the user.
	 * 
	 * @since 1.4
	 */
	 ...
	 * Window, title ...) the <code>JRootPane</code> should provide. The default
	 * is to provide no Window decorations (<code>NONE</code>).
	 * <p>
	 * This is only a hint, and some look and feels may not support this. This is
	 * a bound property.
	 * 
	 ...
	 *           <code>FILE_CHOOSER_DIALOG</code>, <code>QUESTION_DIALOG</code>,
	 *           or <code>WARNING_DIALOG</code>.
	 * @since 1.4
	 * @beaninfo bound: true enum: NONE JRootPane.NONE FRAME JRootPane.FRAME
	 *           PLAIN_DIALOG JRootPane.PLAIN_DIALOG INFORMATION_DIALOG
	 *           JRootPane.INFORMATION_DIALOG ERROR_DIALOG JRootPane.ERROR_DIALOG
	 *           COLOR_CHOOSER_DIALOG JRootPane.COLOR_CHOOSER_DIALOG
	 *           FILE_CHOOSER_DIALOG JRootPane.FILE_CHOOSER_DIALOG QUESTION_DIALOG
	 *           JRootPane.QUESTION_DIALOG WARNING_DIALOG JRootPane.WARNING_DIALOG
	 *           expert: true attribute: visualUpdate true description: Identifies
	 *           the type of Window decorations to provide
	 */
	...
	protected Container createContentPane() {
		...
		c.setLayout(new BorderLayout() {
			/*
			 * This BorderLayout subclass maps a null constraint to CENTER. Although
			 * the reference BorderLayout also does this, some VMs throw an
	 ...
	 * content pane and an optional <code>JMenuBar</code>.
	 * 
	 * @param layered
	...
	/**
	 * Sets a specified <code>Component</code> to be the glass pane for this root
	 * pane. The glass pane should normally be a lightweight, transparent
	 * component, because it will be made visible when ever the root pane needs to
	 * grab input events.
	 * <p>
	 * The new glass pane's visibility is changed to match that of the current
	 * glass pane. An implication of this is that care must be taken when you want
	 * to replace the glass pane and make it visible. Either of the following will
	 * work:
	 * 
	 * <pre>
	 ...
	 * bounds, which means <code>JRootPane</code> does not tiles its children and
	 * this should return false. On the other hand, the <code>glassPane</code> is
	 * normally not visible, and so this can return true if the
	 * <code>glassPane</code> isn't visible. Therefore, the return value here
	 * depends upon the visiblity of the <code>glassPane</code>.
	 * 
	 ...
	 * default button for this <code>JRootPane</code>. The default button is the
	 * button which will be activated when a UI-defined activation event
	 * (typically the <b>Enter</b> key) occurs in the root pane regardless of
	 * whether or not the button has keyboard focus (unless there is another
	 * component within the root pane which consumes the activation event, such as
	 * a <code>JTextPane</code>). For default activation to work, the button must
	 * be an enabled descendent of the root pane when activation occurs. To remove
	 * a default button from this root pane, set this property to
	 * <code>null</code>.
	 * 
	...
	/**
	 * Returns a string representation of this <code>JRootPane</code>. This method
