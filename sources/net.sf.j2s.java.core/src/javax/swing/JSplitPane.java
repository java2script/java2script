...
public class JSplitPane extends JComponent {
	/**
	 * Vertical split indicates the <code>Component</code>s are split along the y
	 * axis. For example the two <code>Component</code>s will be split one on top
	 * of the other.
	 */
	public final static int VERTICAL_SPLIT = 0;

	/**
	 * Horizontal split indicates the <code>Component</code>s are split along the
	 * x axis. For example the two <code>Component</code>s will be split one to
	...
	/**
	 * Location of the divider, at least the value that was set, the UI may have a
	 * different value.
	 */
	 ...
	 *          a boolean, true for the components to redraw continuously as the
	 *          divider changes position, false to wait until the divider position
	 *          stops changing to redraw
	 * @exception IllegalArgumentException
	 *              if <code>orientation</code> is not one of HORIZONTAL_SPLIT or
	 *              VERTICAL_SPLIT
	 */
	 ...
	 *          horizontally-split pane, or at the bottom of a vertically-split
	 *          pane
	 * @exception IllegalArgumentException
	 *              if <code>orientation</code> is not one of: HORIZONTAL_SPLIT or
	 *              VERTICAL_SPLIT
	...
	public JSplitPane(int newOrientation, boolean newContinuousLayout,
		...
		if (orientation != HORIZONTAL_SPLIT && orientation != VERTICAL_SPLIT)
			throw new IllegalArgumentException("cannot create JSplitPane, "
					+ "orientation must be one of " + "JSplitPane.HORIZONTAL_SPLIT "
	 ...
	 * @beaninfo preferred: true description: The component to the left (or above)
	 *           the divider.
	 */
	...
	/**
	 * Sets the value of the <code>oneTouchExpandable</code> property, which must
	 * be <code>true</code> for the <code>JSplitPane</code> to provide a UI widget
	 * on the divider to quickly expand/collapse the divider. The default value of
	 * this property is <code>false</code>. Some look and feels might not support
	 * one-touch expanding; they will ignore this property.
	 * 
	 * @param newValue
	 *          <code>true</code> to specify that the split pane should provide a
	 ...
	 *          an integer specifying the last divider location in pixels, from
	 *          the left (or upper) edge of the pane to the left (or upper) edge
	 *          of the divider
	 ...
	 *              VERTICAL_SPLIT.
	 * @beaninfo bound: true description: The orientation, or how the splitter is
	 *           divided. enum: HORIZONTAL_SPLIT JSplitPane.HORIZONTAL_SPLIT
	...
	/**
	 * Sets the value of the <code>continuousLayout</code> property, which must be
	 * <code>true</code> for the child components to be continuously redisplayed
	 * and laid out during user intervention. The default value of this property
	 * is <code>false</code>. Some look and feels might not support continuous
	 * layout; they will ignore this property.
	 * 
	 * @param newContinuousLayout
	 *          <code>true</code> if the components should continuously be redrawn
	 *          as the divider changes position
	 ...
	 * @since 1.3
	 * @beaninfo bound: true description: Specifies how to distribute extra space
	 *           when the split pane resizes.
	 */
	 ...
	 * 
	 * @return how extra space is to be distributed on a resize of the split pane
	 * @since 1.3
	 */
	...
	/**
	 * Lays out the <code>JSplitPane</code> layout based on the preferred size of
	 * the children components. This will likely result in changing the divider
	 * location.
	 */
	...
	/**
	 * Returns the last value passed to <code>setDividerLocation</code>. The value
	 * returned from this method may differ from the actual divider location (if
	 * <code>setDividerLocation</code> was passed a value bigger than the curent
	 * size).
	 * 
	 ...
	 * implementation.
	 * 
	 * @return an integer specifying a UI-specific value for the minimum location
	 ...
	 * implementation.
	 * 
	 * @return an integer specifying a UI-specific value for the maximum location
	 *         (typically a pixel count); or -1 if the UI is <code>null</code>
	 */
	 ...
	 * 
	 * @param index
	 *          an integer specifying the component to remove, where 1 specifies
	 *          the left/top component and 2 specifies the bottom/right component
	 */
	@Override
	...
	/**
	 * Returns true, so that calls to <code>revalidate</code> on any descendant of
	 * this <code>JSplitPane</code> will cause a request to be queued that will
	 * validate the <code>JSplitPane</code> and all its descendants.
	 * 
	 * @return true
	...
	protected String paramString() {
		...
		return super.paramString() + ",continuousLayout=" + continuousLayoutString
				+ ",dividerSize=" + dividerSize + ",lastDividerLocation="
				+ lastDividerLocation + ",oneTouchExpandable="
