...
//        }
    ...
    public boolean isFileSystemRoot(File dir) {
        return dir.getAbsolutePath().equals("/");//ShellFolder.isFileSystemRoot(dir);
    }
...
//        return ShellFolder.isComputerNode(dir);
    ...
    public File[] getRoots() {
    	return new File[] { createFileSystemRoot(new File("\\")) };
...
//    	File f = new File(containingDir, "newFolder");
//    	f.mkdir();
//    	return f;
////    	
...
//    @Override
//	public boolean isDrive(File dir) {
//        return false;//isFloppyDrive(dir);
//    }
//
//    @Override
//	public boolean isFloppyDrive(File dir) {
...
//
	...
	public File createNewFolder(File containingDir) throws IOException {
        ...
        // Using NT's default folder name
        File newFolder = createFileObject(containingDir, "newFolder");
