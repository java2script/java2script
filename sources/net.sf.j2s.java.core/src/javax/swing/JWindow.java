 ...
 * manager set on it. Refer to {@link javax.swing.RootPaneContainer} for
...
public class JWindow extends Window implements RootPaneContainer {
	 ...
	 * set to true when the <code>JWindow</code> is constructed.
	 * 
	...
	/**
	 * Creates a window with the specified <code>GraphicsConfiguration</code> of a
	 ...
	 *          the new window with; if gc is <code>null</code>, the system
	 ...
	 * is <code>null</code>, the shared owner will be used and this window will
	 * not be focusable.
	 * <p>
	 * This constructor sets the component's locale property to the value returned
	 * by <code>JComponent.getDefaultLocale</code>.
	 ...
	 * <code>owner</code> is <code>null</code>, the shared owner will be used and
	 ...
	 *          the <code>GraphicsConfiguration</code> that is used to construct
	 *          the new window with; if gc is <code>null</code>, the system
	 *          default <code>GraphicsConfiguration</code> is assumed, unless
	 *          <code>owner</code> is also null, in which case the
	...
	public JWindow(Window owner, GraphicsConfiguration gc) {
		super(
				owner == null ? (Window) SwingUtilities.getSharedOwnerFrame() : owner,
				gc);
		if (owner == null) {
			WindowListener ownerShutdownListener = (WindowListener) SwingUtilities
					.getSharedOwnerFrameShutdownListener();
	 ...
	 * {@code DropTarget}.
	 * <p>
	 * Note: When used with {@code JWindow}, {@code TransferHandler} only provides
	 ...
	 *          false if they should operate directly on the <code>JWindow</code>.
	 * 
	 * @see #addImpl
	 * @see #setLayout
	 * @see #isRootPaneCheckingEnabled
	 ...
	 * a child of the <code>JWindow</code> or <code>contentPane</code>.
	 * 
	 * @param comp
	...
	/**
	 * Sets the <code>contentPane</code> property for this window. This method is
	 * called by the constructor.
	 * 
	 * @param contentPane
	 ...
	 * 
	 * @beaninfo hidden: true description: The pane which holds the various window
	 *           layers.
	 */
	@Override
