...
public class Popup {
	 ...
	 * the Component <code>contents</code>. <code>owner</code> is used to determine
	 * which <code>Window</code> the new <code>Popup</code> will parent the
	 * <code>Component</code> the <code>Popup</code> creates to. A null
	 * <code>owner</code> implies there is no valid parent. <code>x</code> and
	 * <code>y</code> specify the preferred initial location to place the
	 * <code>Popup</code> at. Based on screen size, or other paramaters, the
	 * <code>Popup</code> may not display at <code>x</code> and <code>y</code>.
	 *
	...
	/**
	 * Makes the <code>Popup</code> visible. If the <code>Popup</code> is currently
	 * visible, this has no effect.
	 */
	public void show() {
	...
	/**
	 * Causes the <code>Popup</code> to be sized to fit the preferred size of the
	 * <code>Component</code> it contains.
	 */
	void pack() {
		Component component = getComponent();
	 ...
	 * <code>Window</code> created for the <code>Popup</code>. This creates a new
	 * <code>DefaultFrame</code>, if necessary.
	 */
...
//        }
	...
	/**
	 * Returns the <code>Component</code> returned from <code>createComponent</code>
	 * that will hold the <code>Popup</code>.
	 */
	 ...
	 * <p>
	 * PopupFactory uses this as a way to know when the Popup shouldn't be cached
	 * based on the Window.
	 */
