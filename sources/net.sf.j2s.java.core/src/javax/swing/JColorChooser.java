 ...
 * choosers, see <a href=
 * "http://java.sun.com/docs/books/tutorial/uiswing/components/colorchooser.html">How
 * to Use Color Choosers</a>, a section in <em>The Java Tutorial</em>.
 *
 * <p>
 *
...
public class JColorChooser extends JComponent {
	...
	public static Color showDialog(Component component, String title, Color initialColor) {
		...
		// Java: blocks until user brings dialog down...
		// ok.getColor()
	...
	public static JDialog createDialog(Component c, String title, boolean modal, JColorChooser chooserPane,
		...
		return createDialog(c, title, modal, chooserPane, okListener, cancelListener, false);
	}
...
class ColorChooserDialog extends JDialog {
	...
	// BH SwingJS - need to differentiate user-created vs static JColorChooser.show... call
	private boolean disposeOnHide = true;

	public ColorChooserDialog(Dialog owner, String title, boolean modal, Component c, JColorChooser chooserPane,
			ActionListener okListener, ActionListener cancelListener) {
		super(owner, title, modal);
		initColorChooserDialog(c, chooserPane, okListener, cancelListener);
	}

	ColorChooserDialog(Dialog owner, String title, boolean modal, Component c, JColorChooser chooserPane,
			ActionListener okListener, ActionListener cancelListener, boolean disposeOnHide) {
		super(owner, title, modal);
