...
public class JToolBar extends JComponent implements SwingConstants {
	 ...
	 * <code>orientation</code>. All other constructors call this constructor. If
	 ...
	 * <code>null</code> causes the tool bar to use the default margins. The tool
	 * bar's default <code>Border</code> object uses this value to create the
	 * proper margin. However, if a non-default border is set on the tool bar, it
	 * is that <code>Border</code> object's responsibility to create the
	 * appropriate margin space (otherwise this property will effectively be
	 * ignored).
	 * 
	 * @param m
	 *          an <code>Insets</code> object that defines the space between the
	...
	/**
	 * Sets the <code>borderPainted</code> property, which is <code>true</code> if
	 * the border should be painted. The default value for this property is
	 * <code>true</code>. Some look and feels might not implement painted borders;
	...
	/**
	 * Paints the tool bar's border if the <code>borderPainted</code> property is
	 * <code>true</code>.
	 * 
	 * @param g
	 *          the <code>Graphics</code> context in which the painting is done
	 ...
	 * dragged into a different position within the same container or out into its
	 * own window. The default value of this property is <code>true</code>. Some
	 * look and feels might not implement floatable tool bars; they will ignore
	 * this property.
	 * 
	 * @param b
	 ...
	 *              <code>VERTICAL</code>
	 * @see #getOrientation
	 * @beaninfo description: The current orientation of the tool bar bound: true
	 *           preferred: true enum: HORIZONTAL SwingConstants.HORIZONTAL
	...
	/**
	 * Sets the rollover state of this toolbar. If the rollover state is true then
	 * the border of the toolbar buttons will be drawn only when the mouse pointer
	 * hovers over them. The default value of this property is false.
	 * <p>
	...
	/**
	 * A toolbar-specific separator. An object with dimension but no contents used
	 * to divide buttons on a tool bar into groups.
	 */
	static public class Separator extends JSeparator {
		private Dimension separatorSize;

		/**
		 * Creates a new toolbar separator with the default size as defined by the
		 ...
		 * 
		 * @return the <code>Dimension</code> object containing the separator's size
	...
	/**
	 * Returns a string representation of this <code>JToolBar</code>. This method
	...
	protected String paramString() {
		...
		return super.paramString() + ",floatable=" + floatableString + ",margin="
				+ marginString + ",orientation=" + orientationString + ",paintBorder="
				+ paintBorderString;
	}

	private class DefaultToolBarLayout implements LayoutManager2,
