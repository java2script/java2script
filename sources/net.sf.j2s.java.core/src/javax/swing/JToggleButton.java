...
public class JToggleButton extends AbstractButton {
	...
	/**
	 * Creates an initially unselected toggle button with the specified image but no
	 * text.
	 *
	...
	/**
	 * Creates a toggle button that has the specified text and image, and that is
