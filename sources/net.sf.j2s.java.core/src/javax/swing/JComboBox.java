...
public class JComboBox extends JComponent implements ItemSelectable, ListDataListener, ActionListener {
	 ...
	 * @j2sNative
	 * 
	 * 			this.c$$TEA = C$.c$$OA; this.prototype.setPrototypeDisplayValue$TE
	 *            = this.prototype.setPrototypeDisplayValue$O;
	 *            this.prototype.addItem$TE = this.prototype.addItem$O;
	 *            this.prototype.insertItemAt$TE$I =
	 *            this.prototype.insertItemAt$O$I;
	 * 
	 */
	static {
	}
	 ...
	 * <code>ComboBoxModel</code>. Since the <code>ComboBoxModel</code> is provided,
	 * a combo box created using this constructor does not create a default combo
	 * box model and may impact how the insert, remove and add methods behave.
	 *
	 * @param aModel the <code>ComboBoxModel</code> that provides the displayed list
	 *               of items
	 * @see DefaultComboBoxModel
	 */
	...
	/**
	 * Creates a <code>JComboBox</code> that contains the elements in the specified
	 * array. By default the first item in the array (and therefore the data model)
	 * becomes selected.
	 *
	...
	/**
	 * Creates a <code>JComboBox</code> that contains the elements in the specified
	 * Vector. By default the first item in the vector (and therefore the data
	...
	/**
	 * Creates a <code>JComboBox</code> with a default data model. The default data
	 * model is an empty list of objects. Use <code>addItem</code> to add items. By
	 * default the first item in the data model becomes selected.
	 *
	 * @see DefaultComboBoxModel
	 */
	public JComboBox() {
	...
	/**
	 * Sets the data model that the <code>JComboBox</code> uses to obtain the list
	 * of items.
	 *
	 * @param aModel the <code>ComboBoxModel</code> that provides the displayed list
	 *               of items
	 *
	 * @beaninfo bound: true description: Model that the combo box uses to get data
	 *           to display.
	 */
	...
	/**
	 * Sets the <code>lightWeightPopupEnabled</code> property, which provides a hint
	 * as to whether or not a lightweight <code>Component</code> should be used to
	 * contain the <code>JComboBox</code>, versus a heavyweight
	 * <code>Component</code> such as a <code>Panel</code> or a <code>Window</code>.
	 * The decision of lightweight versus heavyweight is ultimately up to the
	 * <code>JComboBox</code>. Lightweight windows are more efficient than
	 * heavyweight windows, but lightweight and heavyweight components do not mix
	 * well in a GUI. If your application mixes lightweight and heavyweight
	 * components, you should disable lightweight popups. The default value for the
	 * <code>lightWeightPopupEnabled</code> property is <code>true</code>, unless
	 * otherwise specified by the look and feel. Some look and feels always use
	 * heavyweight popups, no matter what the value of this property.
	 * <p>
	 * See the article <a href=
	 * "http://java.sun.com/products/jfc/tsc/articles/mixing/index.html">Mixing
	 * Heavy and Light Components</a> on
	 ...
	 *
	 * @beaninfo bound: true expert: true description: Set to <code>false</code> to
	 *           require heavyweight popups.
	 */
	...
	/**
	 * Determines whether the <code>JComboBox</code> field is editable. An editable
	 * <code>JComboBox</code> allows the user to type into the field or selected an
	 ...
	 * editable <code>JComboBox</code> displays the selected item in the field, but
	 * the selection cannot be modified.
	 *
	 * @param aFlag a boolean value, where true indicates that the field is editable
	 *
	 * @beaninfo bound: true preferred: true description: If true, the user can type
	 *           a new value in the combo box.
	 */
	...
	/**
	 * Returns true if the <code>JComboBox</code> is editable. By default, a combo
	 * box is not editable.
	 *
	...
	/**
	 * Sets the maximum number of rows the <code>JComboBox</code> displays. If the
	 * number of objects in the model is greater than count, the combo box uses a
	 * scrollbar.
	 *
	 * @param count an integer specifying the maximum number of items to display in
	 *              the list before using a scrollbar
	 * @beaninfo bound: true preferred: true description: The maximum number of rows
	 ...
	 * scrollbar
	 *
	 * @return an integer specifying the maximum number of items that are displayed
	 ...
	 * editable. If it is editable, the editor is used to render and edit the
	 * selected item.
	 * <p>
	 ...
	 * <code>aRenderer.getListCellRendererComponent</code> is called, passing the
	 * list object and an index of -1.
	 *
	 * @param aRenderer the <code>ListCellRenderer</code> that displays the selected
	 *                  item
	 * @see #setEditor
	 * @beaninfo bound: true expert: true description: The renderer that paints the
	 ...
	 * <code>JComboBox</code> is editable. If not editable, the combo box uses the
	 * renderer to paint the selected item.
	 *
	 * @param anEditor the <code>ComboBoxEditor</code> that displays the selected
	 *                 item
	 * @see #setRenderer
	 ...
	 * <p>
	 * If this constitutes a change in the selected item, <code>ItemListener</code>s
	 * added to the combo box will be notified with one or two
	 ...
	 * <code>ItemEvent.DESELECTED</code>. If <code>anObject</code> is in the list
	 * and is not currently selected then an <code>ItemEvent</code> will be fired
	 * and the state change will be <code>ItemEvent.SELECTED</code>.
	 * <p>
	 * <code>ActionListener</code>s added to the combo box will be notified with an
	 * <code>ActionEvent</code> when this method is called.
	 *
	 * @param anObject the list object to select; use <code>null</code> to clear the
	 *                 selection
	 ...
	 * combo box with <code>addItem</code>, <code>insertItemAt</code> or the data
	 * constructors.
	 *
	 ...
	 *                                     <code>anIndex</code> is greater than or
	 *                                     equal to size
	 ...
	 * not always defined if the <code>JComboBox</code> allows selected items that
	 * are not in the list. Returns -1 if there is no selected item or if the user
	 * specified an item which is not in the list.
	 * 
	 * @return an integer specifying the currently selected list item, where 0
	 *         specifies the first item in the list; or -1 if no item is selected or
	 *         if the currently selected item is not in the list
	 */
	 ...
	 * for the UI portion.
	 * <p>
	 * If a prototype display value is specified, the preferred size of the combo
	 * box is calculated by configuring the renderer with the prototype display
	 * value and obtaining its preferred size. Specifying the preferred display
	 * value is often useful when the combo box will be displaying large amounts of
	 * data. If no prototype display value has been specified, the renderer must be
	 ...
	 * @since 1.4
	 * @beaninfo bound: true attribute: visualUpdate true description: The display
	 *           prototype value, used to compute display width and height.
	 */
	 ...
	 * <p>
	 * <strong>Warning:</strong> Focus and keyboard navigation problems may arise if
	 * you add duplicate String objects. A workaround is to add new objects instead
	 * of String objects and make sure that the toString() method is defined. For
	 * example:
	 * 
	 * <pre>
	 ...
	 * if the <code>JComboBox</code> uses a mutable data model.
	 *
	 ...
	 * 
	 * @exception RuntimeException if <code>dataModel</code> is not an instance of
	 ...
	 * a selection has been made. If the combo box is editable, then an
	 ...
	 * combo box is implemented as a <code>JPopupMenu</code>. A custom look and feel
	 * may not implement it this way and will therefore not receive the
	 * notification.
	 *
	 ...
	 *
	 * @return all of the <code>PopupMenuListener</code>s added or an empty array if
	...
	/**
	 * Notifies <code>PopupMenuListener</code>s that the popup portion of the combo
	 * box will become visible.
	 * <p>
	...
	/**
	 * Sets the <code>Action</code> for the <code>ActionEvent</code> source. The new
	 * <code>Action</code> replaces any previously set <code>Action</code> but does
	 * not affect <code>ActionListeners</code> independently added with
	 ...
	 * properties described in <a href="Action.html#buttonActions"> Swing Components
	 * Supporting <code>Action</code></a>. Subsequently, the combobox's properties
	 * are automatically updated as the <code>Action</code>'s properties change.
	 * <p>
	 * This method uses three other methods to set and help track the
	 * <code>Action</code>'s property values. It uses the
	 * <code>configurePropertiesFromAction</code> method to immediately change the
	 * combobox's properties. To track changes in the <code>Action</code>'s property
	 * values, this method registers the <code>PropertyChangeListener</code>
	 * returned by <code>createActionPropertyChangeListener</code>. The default
	 * {@code PropertyChangeListener} invokes the {@code actionPropertyChanged}
	 * method when a property in the {@code Action} changes.
	 *
	 * @param a the <code>Action</code> for the <code>JComboBox</code>, or
	 *          <code>null</code>.
	 * @since 1.3
	 * @see Action
	 * @see #getAction
	 ...
	 * @beaninfo bound: true attribute: visualUpdate true description: the Action
	 *           instance connected with this ActionEvent source
	 */
	...
	/**
	 * Creates and returns a <code>PropertyChangeListener</code> that is responsible
	 * for listening for changes from the specified <code>Action</code> and updating
	 * the appropriate properties.
	 * <p>
	 * <b>Warning:</b> If you subclass this do not create an anonymous inner class.
	 * If you do the lifetime of the combobox will be tied to that of the
	 * <code>Action</code>.
	 *
	 ...
	 * compatibility with <code>ItemSelectable</code>.
	 *
	...
	/**
	 * Selects the list item that corresponds to the specified keyboard character
	 ...
	 * (if it is editable).
	 *
	 * @param b a boolean value, where true enables the component and false disables
	 *          it
	 * @beaninfo bound: true preferred: true description: Whether the combo box is
	 *           enabled.
	 */
	@Override
	 ...
	 *
	 * @param anEditor the <code>ComboBoxEditor</code> that displays the list item
	 *                 in the combo box field and allows it to be edited
	...
	/**
	 * Handles <code>KeyEvent</code>s, looking for the Tab key. If the Tab key is
	 * found, the popup window is closed.
	 *
	 ...
	 * selected item.
	 *
	 * @beaninfo expert: true description: The objects that changes the selection
	...
	/**
	 * Returns the list item at the specified index. If <code>index</code> is out of
	 * range (less than zero or greater than or equal to size) it will return
	 * <code>null</code>.
	 *
	 * @param index an integer indicating the list position, where the first item
	 *              starts at zero
	 * @return the <code>Object</code> at that list position; or <code>null</code>
	 *         if out of range
	 */
	...
	/**
	 * The interface that defines a <code>KeySelectionManager</code>. To qualify as
	 * a <code>KeySelectionManager</code>, the class needs to implement the method
	 * that identifies the list index given a character and the combo box data
	 * model.
	 */
	public interface KeySelectionManager {
		/**
		 * Given <code>aKey</code> and the model, returns the row that should become
		 * selected. Return -1 if no match was found.
		 *
		 * @param aKey   a char value, usually indicating a keyboard key that was
		 *               pressed
		 * @param aModel a ComboBoxModel -- the component's data model, containing the
		 *               list of selectable items
		 * @return an int equal to the selected row, where 0 is the first item and -1 is
		 *         none.
		 */
...
//
	/**
	 * Returns a string representation of this <code>JComboBox</code>. This method
	...
	protected String paramString() {
		...
		return super.paramString() + ",isEditable=" + isEditableString + ",lightWeightPopupEnabled="
				+ lightWeightPopupEnabledString + ",maximumRowCount=" + maximumRowCount + ",selectedItemReminder="
