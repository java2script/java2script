...
//        	if (((JSComponent) comp).秘isNotTabFocusable())
//    			continue; // SwingJS JLabel, JTextArea, JEditorPane
//            
...
//                }
	 ...
	 *
	 * @param aContainer a focus cycle root of aComponent or a focus traversal
	 *                   policy provider
	 * @param aComponent a (possibly indirect) child of aContainer, or aContainer
	 *                   itself
	 * @return the Component that should receive the focus after aComponent, or null
	 *         if no suitable Component can be found
	 * @throws IllegalArgumentException if aContainer is not a focus cycle root of
	 *                                  aComponent or a focus traversal policy
	 *                                  provider, or if either aContainer or
	 *                                  aComponent is null
	 */
	@Override
...
//        }
		...
		// Before all the ckecks below we first see if it's an FTP provider or a focus
		// cycle root.
