 ...
 */
public class JInternalFrame extends JFrame implements
		// Accessible,
...
//    protected boolean resizable;
	 ...
	 * <code>restoreSubcomponentFocus</code> sets this to the value returned from
	 * <code>getMostRecentFocusOwner</code>.
	 */
...
//                addPropertyChangeListener(focusListener);
	...
	/**
	 * Creates a non-resizable, non-closable, non-maximizable, non-iconifiable
	 * <code>JInternalFrame</code> with the specified title. Note that passing in a
	 * <code>null</code> <code>title</code> results in unspecified behavior and
	 * possibly an exception.
	 *
	 * @param title the non-<code>null</code> <code>String</code> to display in the
	 *              title bar
	 */
	...
	/**
	 * Creates a non-maximizable, non-iconifiable <code>JInternalFrame</code> with
	 * the specified title, resizability, and closability.
	 *
	 * @param title     the <code>String</code> to display in the title bar
	 * @param resizable if <code>true</code>, the internal frame can be resized
	...
	/**
	 * Creates a <code>JInternalFrame</code> with the specified title, resizability,
	 * closability, maximizability, and iconifiability. All
	 ...
	 * @beaninfo bound: true hidden: true attribute: visualUpdate true description:
...
//////////////////////////////////////////////////////////////////////////
	 ...
	 * action.
	 * 
	 * @param b a boolean value, where <code>true</code> means this internal frame
	 *          can be closed
	...
	/**
	 * Returns whether this <code>JInternalFrame</code> can be closed by some user
	 * action.
	 * 
	 ...
	 * invoke this method with a <code>false</code> argument; the result of invoking
	 * <code>setClosed(false)</code> is unspecified.
	 *
	 * <p>
	 *
	 * If the internal frame is already closed, this method does nothing and returns
	 * immediately. Otherwise, this method begins by firing an
	 * <code>INTERNAL_FRAME_CLOSING</code> event. Then this method sets the
	 * <code>closed</code> property to <code>true</code> unless a listener vetoes
	 * the property change. This method finishes by making the internal frame
	 * invisible and unselected, and then firing an
	 * <code>INTERNAL_FRAME_CLOSED</code> event.
	 *
	 * <p>
	 *
	 * <b>Note:</b> To reuse an internal frame that has been closed, you must add it
	 * to a container (even if you never removed it from its previous container).
	 * Typically, this container will be the <code>JDesktopPane</code> that
	 * previously contained the internal frame.
	 *
	 * @param b must be <code>true</code>
	 *
	 * @exception PropertyVetoException when the attempt to set the property is
	 *                                  vetoed by the <code>JInternalFrame</code>
	 *
	 * @see #isClosed()
	 ...
	 *
	 * @beaninfo bound: true constrained: true description: Indicates whether this
	...
	/**
	 * Sets the <code>iconable</code> property, which must be <code>true</code> for
	 * the user to be able to make the <code>JInternalFrame</code> an icon. Some
	 * look and feels might not implement iconification; they will ignore this
	 * property.
	 *
	 * @param b a boolean, where <code>true</code> means this internal frame can be
	 *          iconified
	 * @beaninfo preferred: true bound: true description: Determines whether this
	 *           internal frame can be iconified.
	 */
	 ...
	 * iconification. If the internal frame's state changes to iconified, this
	 * method fires an <code>INTERNAL_FRAME_ICONIFIED</code> event. If the state
	 * changes to de-iconified, an <code>INTERNAL_FRAME_DEICONIFIED</code> event is
	 * fired.
	 *
	 * @param b a boolean, where <code>true</code> means to iconify this internal
	 *          frame and <code>false</code> means to de-iconify it
	 * @exception PropertyVetoException when the attempt to set the property is
	 *                                  vetoed by the <code>JInternalFrame</code>
	 *
	 ...
	 *
	 * @beaninfo bound: true constrained: true description: The image displayed when
	 *           this internal frame is minimized.
	 */
	public void setIcon(boolean b) throws PropertyVetoException {
		...
		/*
		 * If an internal frame is being iconified before it has a parent, (e.g., client
		 * wants it to start iconic), create the parent if possible so that we can place
		 * the icon in its proper place on the desktop. I am not sure the call to
		 * validate() is necessary, since we are not going to display this frame yet
		 */
	 ...
	 * <code>JInternalFrame</code> can be maximized by some user action. Some look
	 * and feels might not support maximizing internal frames; they will ignore this
	 * property.
	 *
	 * @param b <code>true</code> to specify that this internal frame should be
	 *          maximizable; <code>false</code> to specify that it should not be
	 * @beaninfo bound: true preferred: true description: Determines whether this
	 *           internal frame can be maximized.
	 */
	...
	public void setMaximum(boolean b) throws PropertyVetoException {
		...
		/*
		 * setting isMaximum above the event firing means that property listeners that,
		 * for some reason, test it will get it wrong... See, for example,
		 * getNormalBounds()
		 */
		isMaximum = b;
	 ...
	 * <code>JInternalFrame</code> normally draws its title bar differently if it is
	 * the selected frame, which indicates to the user that this internal frame has
	 * the focus. When this method changes the state of the internal frame from
	 * deselected to selected, it fires an
	 * <code>InternalFrameEvent.INTERNAL_FRAME_ACTIVATED</code> event. If the change
	 * is from selected to deselected, an
	 ...
	 *
	 * @beaninfo constrained: true bound: true description: Indicates whether this
	 *           internal frame is currently the active frame.
	 */
	public void setSelected(boolean selected) throws PropertyVetoException {
		...
		/*
		 * We don't want to leave focus in the previously selected frame, so we have to
		 * set it to *something* in case it doesn't get set in some other way (as if a
		 * user clicked on a component that doesn't request focus). If this call is
		 * happening because the user clicked on a component that will want focus, then
		 * it will get transfered there later.
		 * 
		 * We test for parent.isShowing() above, because AWT throws a NPE if you try to
		 * request focus on a lightweight before its parent has been made visible
		 */
	...
	/**
	 * Returns whether the <code>JInternalFrame</code> is the currently "selected"
	 * or active frame.
	 *
	 ...
	 * in the top-left corner). This image is not the <code>desktopIcon</code>
	 * object, which is the image displayed in the <code>JDesktop</code> when this
	 * internal frame is iconified.
	 *
	 * Passing <code>null</code> to this function is valid, but the look and feel
	 * can choose the appropriate behavior for that situation, such as displaying no
	 * icon or a default icon for the look and feel.
	 *
	 * @param icon the <code>Icon</code> to display in the title bar
	 * @see #getFrameIcon
	 * @beaninfo bound: true description: The icon shown in the top-left corner of
	 *           this internal frame.
	 */
	...
	/**
	 * Convenience method that moves this component to position -1 if its parent is
	 * a <code>JLayeredPane</code>.
	 */
	...
	public void setCursor(Cursor cursor) {
		...
		if (!(type == Cursor.SW_RESIZE_CURSOR || type == Cursor.SE_RESIZE_CURSOR || type == Cursor.NW_RESIZE_CURSOR
				|| type == Cursor.NE_RESIZE_CURSOR || type == Cursor.N_RESIZE_CURSOR || type == Cursor.S_RESIZE_CURSOR
	 ...
	 *
	 * @param layer an <code>Integer</code> object specifying this frame's desktop
	 *              layer
	 * @see JLayeredPane
...
//                 getParent().repaint(getX(), getY(), getWidth(), getHeight());
	 ...
	 * <code>setLayer(int)</code>, care must be taken not to accidentally clash with
	 * those values.
	 *
	 ...
	 * <code>JDesktop</code> instance. If <code>JInternalFrame</code> finds none,
	 * the <code>desktopIcon</code> tree is searched.
	 *
...
//        return (JDesktopPane)p;
	 ...
	 * @see #getDesktopIcon
	 * @beaninfo bound: true description: The icon shown when this internal frame is
	 *           minimized.
	 */
	 ...
	 *
	 * @return a <code>Rectangle</code> containing the bounds of this frame when in
	 *         the normal state
	 * @since 1.3
	 */
	public Rectangle getNormalBounds() {
		...
		/*
		 * we used to test (!isMaximum) here, but since this method is used by the
		 * property listener for the IS_MAXIMUM_PROPERTY, it ended up getting the wrong
		 * answer... Since normalBounds get set to null when the frame is restored, this
		 * should work better
		 */
	 ...
	 *
	 * @return the component with focus, or <code>null</code> if no children have
	 *         focus
	 * @since 1.3
	 */
	@Override
	 ...
	 * receive the focus when this <code>JInternalFrame</code> is selected. If this
	 * <code>JInternalFrame</code> is currently selected, this method returns the
	 * same component as the <code>getFocusOwner</code> method. If this
	 * <code>JInternalFrame</code> is not selected, then the child component that
	 * most recently requested focus will be returned. If no child component has
	 * ever requested focus, then this <code>JInternalFrame</code>'s initial
	 * focusable component is returned. If no such child exists, then this
	 * <code>JInternalFrame</code>'s default component to focus is returned.
	 *
...
//        }
	...
	/**
	 * Requests the internal frame to restore focus to the last subcomponent that
	 * had focus. This is used by the UI when the user selected this internal frame
	 ...
	 * implementation also forces re-layout, so that frame decorations such as the
	 * title bar are always redisplayed.
	 *
...
///////////////////////////
	...
	/**
	 * Returns an array of all the <code>InternalFrameListener</code>s added to this
	 * <code>JInternalFrame</code> with <code>addInternalFrameListener</code>.
	 *
	 ...
	 * action specified by the internal frame's default close operation. This method
	 * is typically invoked by the look-and-feel-implemented action handler for the
	 * internal frame's close button.
	 *
	 * @since 1.3
	 * @see #setDefaultCloseOperation
	 * @see javax.swing.event.InternalFrameEvent#INTERNAL_FRAME_CLOSING
	...
	public void doDefaultCloseAction() {
		...
		case HIDE_ON_CLOSE:
			...
			/*
			 * should this activate the next frame? that's really desktopmanager's policy...
			 */
			break;
	...
	/**
	 * Adds a <code>VetoableChangeListener</code> to the listener list. The listener
	...
	/**
	 * Removes a <code>VetoableChangeListener</code> from the listener list. This
	 * removes a <code>VetoableChangeListener</code> that was registered for all
	 * properties.
	 *
	 ...
	 *         empty array if no vetoable change listeners are currently registered
	 *
	...
	/**
	 * Returns the default operation that occurs when the user initiates a "close"
	 * on this internal frame.
	 * 
	...
	/**
	 * Causes subcomponents of this <code>JInternalFrame</code> to be laid out at
	 * their preferred size. Internal frames that are iconized or maximized are
	 * first restored and then packed. If the internal frame is unable to be
	 ...
	 * frame is made visible, this method also fires an
	 * <code>INTERNAL_FRAME_OPENED</code> event. This method does nothing if the
	 * internal frame is already visible. Invoking this method has the same result
	 * as invoking <code>setVisible(true)</code>.
	 *
	 * @see #moveToFront
	 * @see #setSelected
	...
	public void show() {
		...
		/*
		 * icon default visibility is false; set it to true so that it shows up when
		 * user iconifies frame
		 */
	 ...
	 * not already closed, this method fires an <code>INTERNAL_FRAME_CLOSED</code>
	 * event. The results of invoking this method are similar to
	 * <code>setClosed(true)</code>, but <code>dispose</code> always succeeds in
	 * closing the internal frame and does not fire an
	 * <code>INTERNAL_FRAME_CLOSING</code> event.
	 *
	...
	/**
	 * Brings this internal frame to the front. Places this internal frame at the
	 * top of the stacking order and makes the corresponding adjustment to other
	 * visible internal frames.
	 *
	 ...
	 * bottom of the stacking order and makes the corresponding adjustment to other
	 * visible internal frames.
	 *
	...
	/**
	 * Does nothing because <code>JInternalFrame</code>s must always be roots of a
	...
	/**
	 * Always returns <code>null</code> because <code>JInternalFrame</code>s must
	 * always be roots of a focus traversal cycle.
	 *
	 ...
	 * that might need a warning string) this method always returns
	 * <code>null</code>.
	 * 
	 * @return <code>null</code>
...
//    } // AccessibleJInternalFrame
	 ...
	 * functionality is moved into <code>JInternalFrame</code>. This class is public
	 * only so that UI objects can display a desktop icon. If an application wants
	 * to display a desktop icon, it should create a <code>JInternalFrame</code>
...
//
		/**
		 * Returns the <code>JInternalFrame</code> that this <code>DesktopIcon</code> is
		 * associated with.
		 *
		...
		/**
		 * Sets the <code>JInternalFrame</code> with which this <code>DesktopIcon</code>
		 * is associated.
		 *
		...
		/**
		 * Convenience method to ask the icon for the <code>Desktop</code> object it
		 * belongs to.
		 *
		 * @return the <code>JDesktopPane</code> that contains this icon's internal
		 *         frame, or <code>null</code> if none found
		 */
		public JDesktopPane getDesktopPane() {
