...
//    private final Map<String, ?> options;
    ...
    private static final Map<String, NativeLibrary> libraries = new HashMap<>();
//
...
//        if ((/** @j2sNative  false && */Native.POINTER_SIZE == 0))
...
//
//						@Override
//						Object invoke(Method invokingMethod, Class<?>[] paramTypes, Class<?> returnType,
//								Object[] inArgs, Map<String, ?> options) {
//							return Integer.valueOf(Native.getLastError());
//						}
//					};
...
//        return simplified;
    ...
    public static final NativeLibrary getInstance(String libraryName) {
        return getInstance(libraryName, (Map) null);//Collections.<String, Object>emptyMap());
    }
    ...
    public static final NativeLibrary getInstance(String libraryName, ClassLoader classLoader) {
        return getInstance(libraryName, (Map) null);//classLoader);
        		//Collections.singletonMap(Library.OPTION_CLASSLOADER, 
        		// classLoader));
    }
...
//                ref = new WeakReference<>(library);
                libraries.put(libraryName, library);// + options, ref);
//                
