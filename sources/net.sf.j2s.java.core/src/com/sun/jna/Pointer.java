...
//    }
    ...
    @Override
    public int hashCode() {
        return peer;//(int) ((peer >>> 32) + (peer & 0xFFFFFFFFL));
    }
...
//
    ...
    public static int nativeValue(Pointer p) {
...
//        }
        @Override
        public String toString() {
            return "const@0x" + Integer.toHexString(peer);
        }
//    }
}
