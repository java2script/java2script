 ...
 * There is also a facility for reconstructing a <code>String</code> from data
 * in <a href="#modified-utf-8">modified UTF-8</a> format.
 * <p>
 ...
 * particular, an <code>IOException</code> may be thrown if the input stream has
 * been closed.
 * 
 ...
 * column.
 * <p>
 * All characters in the range <code>'&#92;u0001'</code> to <code>'&#92;u007F'</code> are represented by a single
 * byte:
 * 
 * <blockquote>
 * <table border="1" cellspacing="0" cellpadding="8" width="50%" * summary="Bit values and bytes">
 * <tr>
 * <td></td>
 ...
 * 
 * <p>
 * The null character <code>'&#92;u0000'</code> and characters in the range <code>'&#92;u0080'</code> to <code>'&#92;u07FF'</code> are
 ...
 * 
 * <br>
 * <code>char</code> values in the range <code>'&#92;u0800'</code> to <code>'&#92;uFFFF'</code> are represented by
 * three bytes:
 * 
 * <blockquote>
 * <table border="1" cellspacing="0" cellpadding="8" width="50%" * summary="Bit values and bytes">
 ...
 * following:
 * <ul>
 * <li>The null byte <code>'&#92;u0000'</code> is encoded in 2-byte format rather than 1-byte, so
...
public interface DataInput {
   ...
   * is thrown. If <code>off</code> is negative, or <code>len</code> is
   * negative, or <code>off+len</code> is greater than the length of the array
   * <code>b</code>, then an <code>IndexOutOfBoundsException</code> is thrown.
   * If <code>len</code> is zero, then no bytes are read. Otherwise, the first
   * byte read is stored into element <code>b[off]</code>, the next one into
   ...
   * number of conditions; reaching end of file before <code>n</code> bytes have
   * been skipped is only one possibility. This method never throws an
   * <code>EOFException</code>. The actual number of bytes skipped is returned.
   * 
   * @param n
   ...
   * <code>false</code> if that byte is zero. This method is suitable for
   * reading the byte written by the <code>writeBoolean</code> method of
   ...
   * the range <code>-128</code> through <code>127</code>, inclusive. This
   ...
   * the result, which is therefore in the range <code>0</code> through
   * <code>255</code>. This method is suitable for reading the byte written by
   * the <code>writeByte</code> method of interface <code>DataOutput</code> if
   * the argument to <code>writeByte</code> was intended to be a value in the
   ...
   * <code>writeShort</code> method of interface <code>DataOutput</code>.
   * 
   ...
   * <code>0</code> through <code>65535</code>. Let <code>a</code> be the first
   ...
   * 
   * This method is suitable for reading the bytes written by the
   * <code>writeShort</code> method of interface <code>DataOutput</code> if the
   * argument to <code>writeShort</code> was intended to be a value in the range
   ...
   * <code>a-h</code> be the first through eighth bytes read. The value returned
   * is:
   * <p>
   * 
   * <pre>
   ...
   * <p>
   * This method is suitable for reading bytes written by the
   * <code>writeLong</code> method of interface <code>DataOutput</code>.
   * 
  ...
  /**
   * Reads four input bytes and returns a <code>float</code> value. It does this
   * by first constructing an <code>int</code> value in exactly the manner of
   * the <code>readInt</code> method, then converting this <code>int</code>
   * value to a <code>float</code> in exactly the manner of the method
   * <code>Float.intBitsToFloat</code>. This method is suitable for reading
   * bytes written by the <code>writeFloat</code> method of interface
  ...
  /**
   * Reads eight input bytes and returns a <code>double</code> value. It does
   * this by first constructing a <code>long</code> value in exactly the manner
   * of the <code>readlong</code> method, then converting this <code>long</code>
   * value to a <code>double</code> in exactly the manner of the method
   * <code>Double.longBitsToDouble</code>. This method is suitable for reading
   * bytes written by the <code>writeDouble</code> method of interface
   * <code>DataOutput</code>.
   * 
   ...
   * returned as a <code>String</code>. Note that because this method processes
   ...
   * the character <code>'\r'</code> is encountered, it is discarded and, if the
   * following byte converts &#32;to the character <code>'\n'</code>, then that
   * is discarded also; reading then ceases. If end of file is encountered
   * before either of the characters <code>'\n'</code> and <code>'\r'</code> is
   * encountered, reading ceases. Once reading has ceased, a <code>String</code>
   ...
   * than <code>&#92;u0100</code>, that is, <code>(char)256</code>.
   * 
   ...
   * href="#modified-utf-8">modified UTF-8</a> format. The general contract of
   * <code>readUTF</code> is that it reads a representation of a Unicode
   * character string encoded in modified UTF-8 format; this string of
   * characters is then returned as a <code>String</code>.
   * <p>
   * First, two bytes are read and used to construct an unsigned 16-bit integer
   * in exactly the manner of the <code>readUnsignedShort</code> method . This
   ...
   * <p>
   * If the first byte of a group matches the bit pattern <code>0xxxxxxx</code> (where
   * <code>x</code> means "may be <code>0</code> or <code>1</code>"), then the
   * group consists of just that byte. The byte is zero-extended to form a
   * character.
   * <p>
   * If the first byte of a group matches the bit pattern <code>110xxxxx</code>,
   * then the group consists of that byte <code>a</code> and a second byte
   * <code>b</code>. If there is no byte <code>b</code> (because byte
   * <code>a</code> was the last of the bytes to be read), or if byte
   * <code>b</code> does not match the bit pattern <code>10xxxxxx</code>, then a
   * <code>UTFDataFormatException</code> is thrown. Otherwise, the group is
   ...
   * </pre>
   * 
   * If the first byte of a group matches the bit pattern <code>1110xxxx</code>,
   * then the group consists of that byte <code>a</code> and two more bytes
   * <code>b</code> and <code>c</code>. If there is no byte <code>c</code>
   * (because byte <code>a</code> was one of the last two of the bytes to be
   * read), or either byte <code>b</code> or byte <code>c</code> does not match
   * the bit pattern <code>10xxxxxx</code>, then a
   * <code>UTFDataFormatException</code> is thrown. Otherwise, the group is
   * converted to the character:
   * <p>
   * 
   ...
   * which is returned.
   * <p>
   * The <code>writeUTF</code> method of interface <code>DataOutput</code> may
