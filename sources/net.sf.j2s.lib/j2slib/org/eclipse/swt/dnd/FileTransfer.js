Clazz.load(["$wt.dnd.ByteArrayTransfer"],"$wt.dnd.FileTransfer",["java.lang.StringBuffer","$wt.dnd.DND"],function(){
c$=$_C(function(){
$_Z(this,arguments);
},$wt.dnd,"FileTransfer",$wt.dnd.ByteArrayTransfer);
$_K(c$,
($fz=function(){
...
allFiles.append($wt.dnd.FileTransfer.CF_HDROP_SEPARATOR);
}
...
$_V(c$,"getTypeNames",
function(){
return[$wt.dnd.FileTransfer.CF_HDROP];
});
$_M(c$,"checkFile",
function(object){
