...
if(control.getData($wt.dnd.DragSource.DRAGSOURCEID)!=null){
$wt.dnd.DND.error(2000);
}control.setData($wt.dnd.DragSource.DRAGSOURCEID,this);
this.AddRef();
...
this.control.setData($wt.dnd.DragSource.DRAGSOURCEID,null);
this.control=null;
this.transferAgents=null;
},$fz.isPrivate=true,$fz));
