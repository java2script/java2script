Clazz.load(["$wt.dnd.ByteArrayTransfer"],"$wt.dnd.URLTransfer",["java.net.URL","$wt.dnd.DND"],function(){
c$=$_C(function(){
$_Z(this,arguments);
},$wt.dnd,"URLTransfer",$wt.dnd.ByteArrayTransfer);
$_K(c$,
($fz=function(){
...
$_V(c$,"getTypeNames",
function(){
return[$wt.dnd.URLTransfer.CFSTR_INETURL];
});
$_M(c$,"checkURL",
function(object){
if(object==null||!($_O(object,String))||(object).length==0)return false;
var strings=object;
...
c$.CFSTR_INETURLID=c$.prototype.CFSTR_INETURLID=$wt.dnd.Transfer.registerType($wt.dnd.URLTransfer.CFSTR_INETURL);
});
