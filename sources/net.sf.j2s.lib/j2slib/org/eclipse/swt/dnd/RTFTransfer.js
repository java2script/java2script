Clazz.load(["$wt.dnd.ByteArrayTransfer"],"$wt.dnd.RTFTransfer",["$wt.dnd.DND"],function(){
c$=$_C(function(){
$_Z(this,arguments);
},$wt.dnd,"RTFTransfer",$wt.dnd.ByteArrayTransfer);
$_K(c$,
($fz=function(){
...
$_V(c$,"getTypeNames",
function(){
return[$wt.dnd.RTFTransfer.CF_RTF];
});
$_M(c$,"checkRTF",
function(object){
...
c$.CF_RTFID=c$.prototype.CF_RTFID=$wt.dnd.Transfer.registerType($wt.dnd.RTFTransfer.CF_RTF);
});
