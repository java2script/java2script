...
return $_N($wt.custom.TableTree$1,i$,v$);
})(this,null);
...
return $_N($wt.custom.TableTree$2,i$,v$);
})(this,null);
var events=[12,11,15];
...
result[i]=selection[i].getData($wt.custom.TableTree.ITEMID);
}
return result;
});
...
var item=items[i].getData($wt.custom.TableTree.ITEMID);
