...
Clazz.load (["junit.framework.TestListener"], "junit.runner.BaseTestRunner", ["java.io.BufferedReader", "$.File", "$.FileInputStream", "$.FileOutputStream", "$.PrintWriter", "$.StringReader", "$.StringWriter", "java.lang.reflect.Modifier", "java.text.NumberFormat", "java.util.Properties", "junit.framework.TestSuite", "junit.runner.ReloadingTestSuiteLoader", "$.StandardTestSuiteLoader"], function () {
...
function (runTime) {
return java.text.NumberFormat.getInstance ().format (runTime / 1000);
}, "~N");
