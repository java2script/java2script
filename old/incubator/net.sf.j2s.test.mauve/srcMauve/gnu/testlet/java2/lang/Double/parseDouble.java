...
public class parseDouble implements Testlet 
{
  ...
  public void testRegular(TestHarness harness) 
  {
    ...
    try
    {
      ...
      harness.check(false, "parseDouble Double.parseDouble(null)");        
    }
  ...
  public void testInfinities(TestHarness harness) 
  {
    try 
    {
      harness.check(Double.parseDouble("Infinity"), Double.POSITIVE_INFINITY, "parseDouble Infinity");
      harness.check(Double.parseDouble("+Infinity"), Double.POSITIVE_INFINITY, "parseDouble +Infinity");
      harness.check(Double.parseDouble("-Infinity"), Double.NEGATIVE_INFINITY, "parseDouble -Infinity");
      harness.check(Double.parseDouble(" +Infinity "), Double.POSITIVE_INFINITY, "parseDouble +Infinity");
      harness.check(Double.parseDouble(" -Infinity "), Double.NEGATIVE_INFINITY, "parseDouble -Infinity");
    }
    catch (Exception e) 
    ...
    harness.check(Double.parseDouble("1e1000"), Double.POSITIVE_INFINITY, "parseDouble testInfinities 1e1000");
    harness.check(Double.parseDouble("-1e1000"), Double.NEGATIVE_INFINITY, "parseDouble testInfinities -1e1000");
  }
  ...
  public void testNaN(TestHarness harness) 
  {
    try
    {
      harness.check(Double.isNaN(Double.parseDouble("NaN")), "parseDouble testNaN NAN");
      harness.check(Double.isNaN(Double.parseDouble("+NaN")), "parseDouble testNaN +NAN");
      harness.check(Double.isNaN(Double.parseDouble("-NaN")), "parseDouble testNaN -NAN");
      harness.check(Double.isNaN(Double.parseDouble(" +NaN ")), "parseDouble testNaN   +NAN");
      harness.check(Double.isNaN(Double.parseDouble(" -NaN ")), "parseDouble testNaN   -NAN");
