...
if (!Clazz.isClassDefined ("org.eclipse.jface.viewers.TableEditorImpl$1")) {
Clazz.pu$h ();
...
return Clazz.innerTypeInstance (org.eclipse.jface.viewers.TableEditorImpl$1, i$, v$);
}) (this, null);
}control.addFocusListener (this.focusListener);
this.mouseListener = (function (i$, v$) {
if (!Clazz.isClassDefined ("org.eclipse.jface.viewers.TableEditorImpl$2")) {
Clazz.pu$h ();
...
return Clazz.innerTypeInstance (org.eclipse.jface.viewers.TableEditorImpl$2, i$, v$);
...
if (!Clazz.isClassDefined ("org.eclipse.jface.viewers.TableEditorImpl$3")) {
Clazz.pu$h ();
...
return Clazz.innerTypeInstance (org.eclipse.jface.viewers.TableEditorImpl$3, i$, v$);
}) (this, null);
}, $fz.isPrivate = true, $fz));
