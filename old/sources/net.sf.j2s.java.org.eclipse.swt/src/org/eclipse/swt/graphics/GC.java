...
public void drawText (String string, int x, int y, int flags) {
	...
	*/
	...
	rect.style.color = fgColor.getCSSHandle();
	handle.appendChild(rect);
	rect.appendChild(document.createTextNode(string));
}
 ...
 */
public int hashCode () {
	return handle.toString().hashCode(); // TODO
}
