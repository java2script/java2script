...
/**
 * 
 * @modified by  sgurin added support for decode()
 *
 */
public class IntegerTest implements Testlet
{
  ...
  protected static TestHarness harness;
	...
	public void test_toHexString()
	{
		...
		harness.check( "20b7".equals(str), 
			"test_toHexString - 1, value: "+str );

		harness.check( "ffffeb0f".equals(str1),
			"test_toHexString - 2, value: "+str);	
	}
	...
	public void test_toOctalString()
	{
		...
		harness.check(!( !str.equals("13327")), 
			"test_toOctalString - 1 value: "+str );

		harness.check(!( !str1.equals("37777754571")), 
			"test_toOctalString - 2, value: "+str );	
	}
	...
	public void test_valueOf( )
	{
		harness.check(!( Integer.valueOf("21234").intValue() != Integer.parseInt("21234")), 
			"test_valueOf - 1" );	
		harness.check(!( Integer.valueOf("21234").intValue() != 21234), "test_valueOf - 1.1" );
  ...
  private void test_decode() {
	  harness.check(Integer.decode("123").intValue()==123, "test_decode - 1");
	}
