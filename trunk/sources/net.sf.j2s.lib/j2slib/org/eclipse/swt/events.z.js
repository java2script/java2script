...
$_L(t$e,"$wt.events.ArmEvent",null,function(){
c$=$_T($wt.events,"ArmEvent",$wt.events.TypedEvent);
});
$_L(t$e,"$wt.events.ControlEvent",null,function(){
c$=$_T($wt.events,"ControlEvent",$wt.events.TypedEvent);
});
$_L(t$e,"$wt.events.DisposeEvent",null,function(){
c$=$_T($wt.events,"DisposeEvent",$wt.events.TypedEvent);
});
$_L(t$e,"$wt.events.FocusEvent",null,function(){
c$=$_T($wt.events,"FocusEvent",$wt.events.TypedEvent);
});
$_L(t$e,"$wt.events.HelpEvent",null,function(){
c$=$_T($wt.events,"HelpEvent",$wt.events.TypedEvent);
});
$_L(t$e,"$wt.events.KeyEvent",null,function(){
c$=$_C(function(){
this.character=0;
this.keyCode=0;
this.stateMask=0;
...
$_L(t$e,"$wt.events.MenuEvent",null,function(){
c$=$_T($wt.events,"MenuEvent",$wt.events.TypedEvent);
});
$_L(t$e,"$wt.events.ModifyEvent",null,function(){
...
$_L(t$e,"$wt.events.MouseEvent",null,function(){
c$=$_C(function(){
this.button=0;
this.stateMask=0;
this.x=0;
...
$_L(t$e,"$wt.events.PaintEvent",null,function(){
c$=$_C(function(){
this.gc=null;
this.x=0;
this.y=0;
...
$_L(t$e,"$wt.events.SelectionEvent",null,function(){
c$=$_C(function(){
this.item=null;
this.detail=0;
this.x=0;
...
$_L(t$e,"$wt.events.ShellEvent",null,function(){
c$=$_C(function(){
this.doit=false;
$_Z(this,arguments);
...
$_L(e$l,"$wt.events.ArmListener",null,function(){
$_I($wt.events,"ArmListener",$wt.internal.SWTEventListener);
});
$_L(e$l,"$wt.events.ControlListener",null,function(){
...
$_L(e$l,"$wt.events.DisposeListener",null,function(){
$_I($wt.events,"DisposeListener",$wt.internal.SWTEventListener);
});
$_L(e$l,"$wt.events.FocusListener",null,function(){
...
$_L(e$l,"$wt.events.HelpListener",null,function(){
$_I($wt.events,"HelpListener",$wt.internal.SWTEventListener);
});
$_L(e$l,"$wt.events.KeyListener",null,function(){
...
$_L(e$l,"$wt.events.MenuListener",null,function(){
...
$_L(e$l,"$wt.events.ModifyListener",null,function(){
$_I($wt.events,"ModifyListener",$wt.internal.SWTEventListener);
});
$_L(e$l,"$wt.events.MouseListener",null,function(){
$_I($wt.events,"MouseListener",$wt.internal.SWTEventListener);
});
$_L(e$l,"$wt.events.MouseMoveListener",null,function(){
$_I($wt.events,"MouseMoveListener",$wt.internal.SWTEventListener);
});
$_L(e$l,"$wt.events.MouseTrackListener",null,function(){
...
$_L(e$l,"$wt.events.PaintListener",null,function(){
$_I($wt.events,"PaintListener",$wt.internal.SWTEventListener);
});
$_L(e$l,"$wt.events.SelectionListener",null,function(){
...
$_L(e$l,"$wt.events.ShellListener",null,function(){
...
$_L(e$l,"$wt.events.TraverseListener",null,function(){
$_I($wt.events,"TraverseListener",$wt.internal.SWTEventListener);
});
$_L(e$l,"$wt.events.TreeListener",null,function(){
...
$_L(e$l,"$wt.events.VerifyListener",null,function(){
