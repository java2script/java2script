Clazz.load(["$wt.dnd.ByteArrayTransfer"],"$wt.dnd.HTMLTransfer",["$wt.dnd.DND"],function(){
c$=$_C(function(){
$_Z(this,arguments);
},$wt.dnd,"HTMLTransfer",$wt.dnd.ByteArrayTransfer);
$_K(c$,
($fz=function(){
...
$_V(c$,"getTypeNames",
function(){
return[$wt.dnd.HTMLTransfer.HTML_FORMAT];
});
$_M(c$,"checkHTML",
function(object){
...
c$.HTML_FORMATID=c$.prototype.HTML_FORMATID=$wt.dnd.Transfer.registerType($wt.dnd.HTMLTransfer.HTML_FORMAT);
});
