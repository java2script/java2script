...
case 2000:
{
var msg=$wt.dnd.DND.INIT_DRAG_MESSAGE;
if(hresult!=0)msg+=" result = "+hresult;
throw new $wt.SWTError(code,msg);
}case 2001:
{
var msg=$wt.dnd.DND.INIT_DROP_MESSAGE;
if(hresult!=0)msg+=" result = "+hresult;
throw new $wt.SWTError(code,msg);
}case 2002:
{
var msg=$wt.dnd.DND.CANNOT_SET_CLIPBOARD_MESSAGE;
if(hresult!=0)msg+=" result = "+hresult;
throw new $wt.SWTError(code,msg);
}case 2003:
{
var msg=$wt.dnd.DND.INVALID_DATA_MESSAGE;
if(hresult!=0)msg+=" result = "+hresult;
