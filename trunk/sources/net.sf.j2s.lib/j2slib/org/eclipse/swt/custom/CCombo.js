...
return $_N($wt.custom.CCombo$1,i$,v$);
})(this,null);
...
return $_N($wt.custom.CCombo$2,i$,v$);
})(this,null);
...
if(siblings[i]==this.b$["$wt.custom.CCombo"]){
...
return $_N($wt.custom.CCombo$3,i$,v$);
})(this,null);
...
return $_N($wt.custom.CCombo$4,i$,v$);
})(this,null));
...
return $_N($wt.custom.CCombo$5,i$,v$);
})(this,null));
...
return $_N($wt.custom.CCombo$6,i$,v$);
})(this,null));
...
return $_N($wt.custom.CCombo$7,i$,v$);
})(this,null));
...
return $_N($wt.custom.CCombo$8,i$,v$);
})(this,null));
});
$_M(c$,"isDropped",
function(){
...
{
if((event.character).charCodeAt(0)==($WT.ESC).charCodeAt(0)){
this.dropDown(false);
}if((event.stateMask&65536)!=0&&(event.keyCode==16777217||event.keyCode==16777218)){
this.dropDown(false);
}if((event.character).charCodeAt(0)==($WT.CR).charCodeAt(0)){
this.dropDown(false);
var e=new $wt.widgets.Event();
e.time=event.time;
e.stateMask=event.stateMask;
