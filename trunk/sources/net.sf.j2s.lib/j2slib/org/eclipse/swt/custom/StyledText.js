Clazz.load(["java.lang.Runnable","$wt.widgets.Canvas","java.util.Hashtable","$.Vector","$wt.graphics.Point"],"$wt.custom.StyledText",["java.lang.Character","$.StringBuffer","$wt.SWT","$wt.accessibility.AccessibleAdapter","$.AccessibleControlAdapter","$.AccessibleTextAdapter","$wt.custom.DefaultContent","$.DefaultLineStyler","$.DisplayRenderer","$.PrintRenderer","$.StyleRange","$.StyledTextEvent","$.StyledTextListener","$.StyledTextPrintOptions","$.TextChangeListener","$.WrappedContent","$wt.dnd.Clipboard","$.RTFTransfer","$.TextTransfer","$.Transfer","$wt.graphics.Color","$.Cursor","$.Font","$.GC","$.Image","$.Rectangle","$.TextLayout","$wt.internal.Compatibility","$wt.printing.Printer","$wt.widgets.Caret","$.Event","$.Listener","$.TypedListener"],function(){
c$=$_C(function(){
...
}}if(e.startsWith(a)==false&&e.startsWith(b)==false&&e.startsWith(c)==false&&(e.startsWith(d)==false||g>4)){
...
var g=e.indexOf($wt.custom.StyledTextPrintOptions.SEPARATOR,c);
var h;
if(g==-1){
h=e.substring(c);
...
h=e.substring(c,g);
this.printDecorationSegment(h,f,a,b);
c=g+$wt.custom.StyledTextPrintOptions.SEPARATOR.length;
}}
},"~N,~B");
$_M(c$,"printDecorationSegment",
function(a,b,c,d){
var e=a.indexOf($wt.custom.StyledTextPrintOptions.PAGE_TAG);
if(e!=-1){
var f=$wt.custom.StyledTextPrintOptions.PAGE_TAG.length;
...
while(i<length){
if(crIndex!=-1){
crIndex=text.indexOf($WT.CR,i);
}if(lfIndex!=-1){
lfIndex=text.indexOf($WT.LF,i);
...
this.setKeyBinding(($WT.DEL).charCodeAt(0)|$WT.MOD2,131199);
this.setKeyBinding(16777225|$WT.MOD1,17039369);
this.setKeyBinding(16777225|$WT.MOD2,16908297);
this.setKeyBinding(($WT.BS).charCodeAt(0)|$WT.MOD2,8);
this.setKeyBinding($WT.BS,8);
this.setKeyBinding($WT.DEL,127);
this.setKeyBinding(($WT.BS).charCodeAt(0)|$WT.MOD1,262152);
this.setKeyBinding(($WT.DEL).charCodeAt(0)|$WT.MOD1,262271);
...
if(direction==128){
timer=(function(i$,v$){
if(!$_D("org.eclipse.swt.custom.StyledText$1")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$1",null,Runnable);
$_V(c$,"run",
function(){
...
return $_N($wt.custom.StyledText$1,i$,v$);
})(this,$_F("display",display));
}else if(direction==1024){
timer=(function(i$,v$){
if(!$_D("org.eclipse.swt.custom.StyledText$2")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$2",null,Runnable);
$_V(c$,"run",
function(){
...
return $_N($wt.custom.StyledText$2,i$,v$);
})(this,$_F("display",display));
}else if(direction==16777220){
timer=(function(i$,v$){
if(!$_D("org.eclipse.swt.custom.StyledText$3")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$3",null,Runnable);
$_V(c$,"run",
function(){
...
return $_N($wt.custom.StyledText$3,i$,v$);
})(this,$_F("display",display));
}else if(direction==16777219){
timer=(function(i$,v$){
if(!$_D("org.eclipse.swt.custom.StyledText$4")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$4",null,Runnable);
$_V(c$,"run",
function(){
...
return $_N($wt.custom.StyledText$4,i$,v$);
})(this,$_F("display",display));
}if(timer!=null){
...
event.start=this.selection.x;
event.end=this.selection.y;
if((key).charCodeAt(0)==($WT.CR).charCodeAt(0)||(key).charCodeAt(0)==($WT.LF).charCodeAt(0)){
if(this.isSingleLine()==false){
event.text=this.getLineDelimiter();
}}else if(this.selection.x==this.selection.y&&this.overwrite==true&&(key).charCodeAt(0)!=($wt.custom.StyledText.TAB).charCodeAt(0)){
...
function(){
this.textChangeListener=(function(i$,v$){
if(!$_D("org.eclipse.swt.custom.StyledText$5")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$5",null,$wt.custom.TextChangeListener);
$_V(c$,"textChanging",
function(event){
...
return $_N($wt.custom.StyledText$5,i$,v$);
})(this,null);
...
if(!$_D("org.eclipse.swt.custom.StyledText$6")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$6",null,$wt.widgets.Listener);
$_V(c$,"handleEvent",
function(event){
switch(event.type){
case 12:
...
return $_N($wt.custom.StyledText$6,i$,v$);
})(this,null);
...
if(verticalBar!=null){
verticalBar.addListener(13,(function(i$,v$){
if(!$_D("org.eclipse.swt.custom.StyledText$7")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$7",null,$wt.widgets.Listener);
$_V(c$,"handleEvent",
function(event){
...
return $_N($wt.custom.StyledText$7,i$,v$);
})(this,null));
}if(horizontalBar!=null){
horizontalBar.addListener(13,(function(i$,v$){
if(!$_D("org.eclipse.swt.custom.StyledText$8")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$8",null,$wt.widgets.Listener);
$_V(c$,"handleEvent",
function(event){
...
return $_N($wt.custom.StyledText$8,i$,v$);
})(this,null));
}});
...
}if(!ignore&&(event.character).charCodeAt(0)>31&&(event.character).charCodeAt(0)!=($WT.DEL).charCodeAt(0)||(event.character).charCodeAt(0)==($WT.CR).charCodeAt(0)||(event.character).charCodeAt(0)==($WT.LF).charCodeAt(0)||(event.character).charCodeAt(0)==($wt.custom.StyledText.TAB).charCodeAt(0)){
...
if(!$_D("org.eclipse.swt.custom.StyledText$9")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$9",$wt.accessibility.AccessibleAdapter);
$_V(c$,"getHelp",
function(e){
...
return $_N($wt.custom.StyledText$9,i$,v$);
})(this,null));
accessible.addAccessibleTextListener((function(i$,v$){
if(!$_D("org.eclipse.swt.custom.StyledText$10")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$10",$wt.accessibility.AccessibleTextAdapter);
$_V(c$,"getCaretOffset",
function(e){
...
return $_N($wt.custom.StyledText$10,i$,v$);
})(this,null));
accessible.addAccessibleControlListener((function(i$,v$){
if(!$_D("org.eclipse.swt.custom.StyledText$11")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$11",$wt.accessibility.AccessibleControlAdapter);
$_V(c$,"getRole",
function(e){
e.detail=42;
...
return $_N($wt.custom.StyledText$11,i$,v$);
})(this,null));
this.addListener(15,(function(i$,v$){
if(!$_D("org.eclipse.swt.custom.StyledText$12")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
$_Z(this,arguments);
},$wt.custom,"StyledText$12",null,$wt.widgets.Listener);
$_V(c$,"handleEvent",
function(event){
...
return $_N($wt.custom.StyledText$12,i$,v$);
})(this,$_F("accessible",accessible)));
});
$_M(c$,"initializeRenderer",
function(){
if(this.renderer!=null){
