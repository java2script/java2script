...
if((ch).charCodeAt(0)==($WT.CR).charCodeAt(0)){
if(i+1<textLength){
ch=this.textStore[i+1];
if((ch).charCodeAt(0)==($WT.LF).charCodeAt(0)){
i++;
}}this.addLineIndex(start,i-start+1);
start=i+1;
}else if((ch).charCodeAt(0)==($WT.LF).charCodeAt(0)){
this.addLineIndex(start,i-start+1);
start=i+1;
}}
...
$_M(c$,"isDelimiter",
function(ch){
if((ch).charCodeAt(0)==($WT.CR).charCodeAt(0))return true;
if((ch).charCodeAt(0)==($WT.LF).charCodeAt(0))return true;
return false;
},"~N");
$_M(c$,"isValidReplace",
...
if((ch).charCodeAt(0)==($WT.CR).charCodeAt(0)){
if(i+1<length&&(text.charAt(i+1)).charCodeAt(0)==($WT.LF).charCodeAt(0)){
i++;
}lineCount++;
}else if((ch).charCodeAt(0)==($WT.LF).charCodeAt(0)){
lineCount++;
...
if(((endText.charAt(0)).charCodeAt(0)==($WT.CR).charCodeAt(0))&&((endText.charAt(1)).charCodeAt(0)==($WT.LF).charCodeAt(0))){
...
if(j+1<this.textStore.length)if((ch).charCodeAt(0)==($WT.CR).charCodeAt(0)&&((this.textStore[j+1]).charCodeAt(0)==($WT.LF).charCodeAt(0)))j++;
eol=true;
}}j++;
}
